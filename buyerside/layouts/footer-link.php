...
<script src="<?php echo iii ?>assets/buyerside/js/app.js"></script>


<script>

    if(localStorage.getItem("rtlbuyerStyle") == '' || localStorage.getItem("rtlbuyerStyle") == null) {
        localStorage.setItem("rtlBootstrap", "<?php echo iii ?>assets/css/bootstrap.min.css");
        localStorage.setItem("rtlbuyerStyle", "<?php echo iii ?>assets/css/buyerStyle.min.css");
    ...
    $('.rtlbuyerStyle').attr('href', localStorage.getItem("rtlbuyerStyle"));
    ...
    function changeLang() {
        ...
        if (bootstrapVar==1) {
            ...
            $('.rtlBootstrap').attr('href', localStorage.getItem("rtlBootstrap"));
            localStorage.setItem("rtlbuyerStyle", "<?php echo iii ?>assets/css/buyerStyle.rtl.min.css");
            $('.rtlbuyerStyle').attr('href', localStorage.getItem("rtlbuyerStyle"));
