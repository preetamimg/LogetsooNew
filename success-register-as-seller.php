...
<main class="main container-fluid px-0 d-flex flex-column ">
    ...
    <div class="bodyPart row mx-0 flex-fill overflow-hidden successRegisterAsSellerPage align-items-md-start align-items-center">
            ...
            <div class="row justify-content-center mx-0 pt-md-5 pt-0">
                <div class="col-12 successPopup bg-white rounded p-5 text-center">
                    <div class="row">
                        ...
                        <div class="col-12 subTitle pt-2"><span class="d-block fw-500">Your seller account has been successfully created.</span></div>
                        <div class="col-9 mx-auto pt-3">
                            <a href="<?php echo iii ?>ad-package-module-seller-package.php" class="btnStyle2 btn btn-theme1 text-white">Start Selling Now</a>
                        </div>
                    </div>
                </div>
            </div>
