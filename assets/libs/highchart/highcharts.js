...
*/
(function(U, K) {
    "object" === typeof module && module.exports ? (K["default"] = K,
    module.exports = U.document ? K(U) : K) : "function" === typeof define && define.amd ? define("highcharts/highcharts", function() {
        return K(U)
    }) : (U.Highcharts && U.Highcharts.error(16, !0),
    U.Highcharts = K(U))
}
)("undefined" !== typeof window ? window : this, function(U) {
    function K(a, C, f, H) {
        a.hasOwnProperty(C) || (a[C] = H.apply(null, f),
        ...
        (function(a) {
            ...
            a.supportsPassiveEvents = function() {
                ...
                if (!a.isMS) {
                    ...
                    a.win.addEventListener && a.win.removeEventListener && (a.win.addEventListener("testPassive", a.noop, C),
    ...
    K(f, "Core/Utilities.js", [f["Core/Globals.js"]], function(a) {
        ...
        function e(b, d, h) {
            var v = w(d) && !k(h), r, l = function(d, h) {
        ...
        function F(d, r, h) {
            ...
            if ("width" === r)
                ...
                h = d.getBoundingClientRect && d.getBoundingClientRect().width,
                h < r && h >= r - 1 && (r = Math.floor(h)),
                Math.max(0, r - (v(d, "padding-left", !0) || 0) - (v(d, "padding-right", !0) || 0));
            if ("height" === r)
                return Math.max(0, Math.min(d.offsetHeight, d.scrollHeight) - (v(d, "padding-top", !0) || 0) - (v(d, "padding-bottom", !0) || 0));
        ...
        function y(b, d, h) {
            for (var v in b)
                Object.hasOwnProperty.call(b, v) && d.call(h || b[v], b[v], v, b)
        }
        function x(b, d, h) {
            function v(d, J) {
        ...
        function z(b, d, l, m) {
            ...
            if (h.createEvent && (b.dispatchEvent || b.fireEvent && b !== a)) {
                ...
                for (var r = b, q = !1; r.hcEvents; )
                    Object.hasOwnProperty.call(r, "hcEvents") && r.hcEvents[d] && (v.length && (q = !0),
                    v.unshift.apply(v, r.hcEvents[d])),
        ...
        b.jQuery && (b.jQuery.fn.highcharts = function() {
            ...
            if (this[0])
                return b[0] ? (new (a[w(b[0]) ? b.shift() : "Chart"])(this[0],b[0],b[1]),
                this) : m[e(this[0], "data-highcharts-chart")]
        }
        );
        l = {
            ...
            merge: function() {
                var b, d = arguments, h = {}, l = function(b, d) {
                    "object" !== typeof b && (b = {});
                    y(d, function(r, J) {
            ...
            normalizeTickInterval: function(b, d, h, l, m) {
                ...
                h = p(h, t(b));
                var v = b / h;
                d || (d = m ? [1, 1.2, 1.5, 2, 2.5, 3, 4, 5, 6, 8, 10] : [1, 2, 2.5, 5, 10],
                !1 === l && (1 === h ? d = d.filter(function(b) {
                    return 0 === b % 1
                }) : .1 >= h && (d = [1 / h])));
                for (l = 0; l < d.length && !(r = d[l],
                m && r * h >= b || !m && v <= (d[l] + (d[l + 1] || d[l])) / 2); l++)
                    ;
    ...
    K(f, "Core/Color/Palettes.js", [], function() {
        return {
            colors: "#f39875 #7e6a9f #30a5a9 #f7a35c #8085e9 #f15c80 #e4d354 #2b908f #f45b5b #91e8e1".split(" ")
        }
    });
    K(f, "Core/Time.js", [f["Core/Globals.js"], f["Core/Utilities.js"]], function(a, f) {
        ...
        f = function() {
            ...
            t.prototype.dateFormat = function(c, e, p) {
                ...
                u(g, function(b, d) {
                    for (; -1 !== c.indexOf("%" + d); )
                        c = c.replace("%" + d, "function" === typeof b ? b.call(q, e) : b)
                });
            ...
            t.prototype.getTimeTicks = function(e, g, p, t) {
                var q = this, m = [], h = {}, b = new q.Date(g), l = e.unitRange, d = e.count || 1, D;
                t = k(t, 1);
                if (H(g)) {
                    ...
                    l === c.week && (v = q.get("Day", b),
                    q.set("Date", b, q.get("Date", b) - v + t + (v < t ? -7 : 0)));
                    v = q.get("FullYear", b);
                    t = q.get("Month", b);
                    var r = q.get("Date", b)
                      , y = q.get("Hours", b);
                    ...
                    for (b = 1; g < p; )
                        m.push(g),
                        g = l === c.year ? q.makeTime(v + b * d, 0) : l === c.month ? q.makeTime(v, t + b * d) : !D || l !== c.day && l !== c.week ? D && l === c.hour && 1 < d ? q.makeTime(v, t, r, y + b * d) : g + l * d : q.makeTime(v, t, r + b * d * (l === c.day ? 1 : 7)),
                        b++;
                    m.push(g);
            ...
            t.prototype.getDateFormat = function(e, g, p, t) {
                ...
                if (b)
                    var l = this.resolveDTLFormat(t[b]).main;
                return l
            }
            ;
            return t
    ...
    K(f, "Core/DefaultOptions.js", [f["Core/Chart/ChartDefaults.js"], f["Core/Color/Color.js"], f["Core/Globals.js"], f["Core/Color/Palettes.js"], f["Core/Time.js"], f["Core/Utilities.js"]], function(a, f, B, H, w, E) {
        ...
        var C = E.merge
          , A = {
            ...
            tooltip: {
                ...
                headerFormat: '<span style="font-size: 0.625em">{point.key}</span><br/>',
        ...
        a = {
            ...
            setOptions: function(n) {
                C(!0, A, n);
                if (n.time || n.global)
                    B.time ? B.time.update(C(A.global, A.time, n.global, n.time)) : B.time = u;
                return A
            }
        };
        "";
        ...
        return function() {
            ...
            a.prototype.update = function() {
                ...
                if (this[n + "Setter"])
                    ...
                    a.attr ? a.element && a.attr(n, k, null, !0) : a.style[n] = k + this.unit;
                e && e.call(a, k, this)
            }
            ;
            a.prototype.run = function(u, n, k) {
                ...
                u !== n || this.elem["forceAnimate:" + this.prop] ? (this.startTime = +new Date,
                this.start = u,
                this.end = n,
                this.unit = k,
                this.now = this.start,
                ...
                p.elem = this.elem,
                p.prop = this.prop,
                p() && 1 === a.timers.push(p) && g(t)) : (delete c.curAnim[this.prop],
            ...
            a.prototype.initPath = function(a, n, k) {
                ...
                function c(c, m) {
                    for (; c.length < x; )
                        if (m = c[Math.floor(c.length / q) - 1].slice(),
                        "C" === m[0] && (m[1] = m[5],
                        m[2] = m[6]),
                        t) {
    ...
    K(f, "Core/Animation/AnimationUtilities.js", [f["Core/Animation/Fx.js"], f["Core/Utilities.js"]], function(a, f) {
        ...
        function H(c, e) {
            for (var g = a.timers.length; g--; )
                a.timers[g].elem !== c || e && e !== a.timers[g].prop || (a.timers[g].stopped = !0)
        }
        var w = f.defined
          , E = f.getStyle
          , I = f.isArray
        ...
        return {
            animate: function(c, e, g) {
                ...
                k(e, function(t, m) {
                    ...
                    y = new a(c,g,m);
                    F = void 0;
                    "d" === m && I(e.d) ? (y.paths = y.initPath(c, c.pathArray, e.d),
                    y.toD = e.d,
                    p = 0,
                    F = 1) : c.attr ? p = c.attr(m) : (p = parseFloat(E(c, m)) || 0,
                    "opacity" !== m && (q = "px"));
                    F || (F = t);
    ...
    K(f, "Core/Renderer/HTML/AST.js", [f["Core/Globals.js"], f["Core/Utilities.js"]], function(a, f) {
        ...
        A = function() {
            ...
            g.prototype.parseMarkup = function(c) {
                ...
                if (p)
                    c = (new DOMParser).parseFromString(e ? e.createHTML(c) : c, "text/html");
                else {
                    var k = w("div");
                    k.innerHTML = c;
                    c = {
    ...
    K(f, "Core/FormatUtilities.js", [f["Core/DefaultOptions.js"], f["Core/Utilities.js"]], function(a, f) {
        function C(a, k, e, c) {
            ...
            if (-1 === k)
                ...
                var F = k + +t[1];
                0 <= F ? (t[0] = (+t[0]).toExponential(F).split("e")[0],
                k = F) : (t[0] = t[0].split(".")[0] || 0,
                a = 20 > k ? (t[0] * Math.pow(10, t[1])).toFixed(k) : 0,
                t[1] = 0)
            }
    ...
    K(f, "Core/Renderer/RendererUtilities.js", [f["Core/Utilities.js"]], function(a) {
        var f = a.clamp, B = a.pick, H = a.stableSort, w;
        (function(a) {
            function C(a, u, n) {
                var k = a, e = k.reducedLen || u, c = function(c, e) {
                ...
                for (a = a.map(function(c) {
                    ...
                    g = a.length;
                    for (t = !1; g--; )
                        0 < g && a[g - 1].pos + a[g - 1].size > a[g].pos && (a[g - 1].size += a[g].size,
                ...
                a.some(function(c) {
                    ...
                    return (c.targets || []).some(function() {
                        ...
                        if ("undefined" !== typeof n && Math.abs(k[g].pos - k[g].target) > n)
                            return k.slice(0, g + 1).forEach(function(c) {
                                return delete c.pos
                            }),
    ...
    K(f, "Core/Renderer/SVG/SVGElement.js", [f["Core/Animation/AnimationUtilities.js"], f["Core/Renderer/HTML/AST.js"], f["Core/Color/Color.js"], f["Core/Globals.js"], f["Core/Utilities.js"]], function(a, f, B, H, w) {
        ...
        a = function() {
            ...
            a.prototype.align = function(b, c, J) {
                var h = {}, l = this.renderer, e = l.alignedObjects, m, a, G;
                if (b) {
            ...
            a.prototype.animate = function(b, d, c) {
                ...
                0 !== h.duration ? (c && (h.complete = c),
                P(function() {
                    J.element && C(J, b, h)
                }, d)) : (this.attr(b, void 0, c || h.complete),
                v(b, function(b, d) {
            ...
            a.prototype.attr = function(b, d, c, h) {
                var J = this.element, l = this.symbolCustomAttribs, r, L = this, G, e;
                ...
                "string" === typeof b ? L = (this[b + "Getter"] || this._defaultGetter).call(this, b, J) : (v(b, function(d, c) {
                    G = !1;
                    h || A(this, c);
                    this.symbolName && -1 !== l.indexOf(c) && (r || (this.symbolAttr(b),
                    r = !0),
                    G = !0);
                    !this.rotation || "x" !== c && "y" !== c || (this.doTransform = !0);
                    G || (e = this[c + "Setter"] || this._defaultSetter,
                    e.call(this, d, c, J),
            ...
            a.prototype.complexColor = function(b, d, c) {
                var J = this.renderer, l, r, e, a, G, g, p, q, k, t, x = [], z;
                m(this.renderer, "complexColor", {
                    ...
                    if (r) {
                        ...
                        "radialGradient" === r && k && !y(e.gradientUnits) && (a = e,
                        e = D(e, J.getRadialAttr(k, a), {
                            gradientUnits: "userSpaceOnUse"
                        }));
                        v(e, function(b, d) {
                            "id" !== d && x.push(d, b)
                        ...
                        if (G[x])
                            ...
                            g.forEach(function(b) {
                                0 === b[1].indexOf("rgba") ? (l = B.parse(b[1]),
                                p = l.get("rgb"),
                                q = l.get("a")) : (p = b[1],
                                q = 1);
            ...
            a.prototype.destroy = function() {
                ...
                b.safeRemoveChild(d);
                for (c.styledMode || b.destroyShadows(); l && l.div && 0 === l.div.childNodes.length; )
                    d = l.parentGroup,
            ...
            a.prototype.getBBox = function(d, c) {
                ...
                var q = e.styledMode ? l && a.prototype.getStyle.call(l, "font-size") : m && m.fontSize, D;
                if (y(v)) {
                    var k = v.toString();
            ...
            a.prototype.setTextPath = function(b, d) {
                ...
                if (b && d && d.enabled) {
                    m && null === m.element.parentNode ? (a = !0,
                    m = m.destroy()) : m && this.removeTextOutline.call(m.parentGroup);
                    ...
                    y(G.dy) && (g.parentNode.setAttribute("dy", G.dy),
                    delete G.dy);
                    y(G.dx) && (g.parentNode.setAttribute("dx", G.dx),
                    delete G.dx);
                    v(G, function(b, d) {
            ...
            a.prototype.shadow = function(b, d, c) {
                var h = [], l = this.element, J = this.oldShadowOptions, r = {
                    color: "#000000",
                ...
                if (!G)
                    ...
                    for (r = 1; r <= G.width; r++) {
                        ...
                        c && (t(g, "height", Math.max(t(g, "height") - p, 0)),
                        g.cutHeight = p);
            ...
            a.prototype.strokeSetter = function(b, d, c) {
                this[d] = b;
                this.stroke && this["stroke-width"] ? (a.prototype.fillSetter.call(this, this.stroke, "stroke", c),
                c.setAttribute("stroke-width", this["stroke-width"]),
                this.hasStroke = !0) : "stroke-width" === d && 0 === b && this.hasStroke ? (c.removeAttribute("stroke"),
                this.hasStroke = !1) : this.renderer.styledMode && this["stroke-width"] && (c.setAttribute("stroke-width", this["stroke-width"]),
                this.hasStroke = !0)
            }
            ;
            ...
            a.prototype.updateShadows = function(b, d, c) {
                ...
                if (h)
                    for (var l = h.length; l--; )
                        c.call(h[l], "height" === b ? Math.max(d - (h[l].cutHeight || 0), 0) : "d" === b ? this.d : d, b, h[l])
            }
            ;
            ...
            a.prototype.zIndexSetter = function(b, d) {
                ...
                var m = this.added;
                var G;
                y(b) ? (r.setAttribute("data-z-index", b),
                b = +b,
                this[d] === b && (m = !1)) : y(this[d]) && r.removeAttribute("data-z-index");
                this[d] = b;
                if (m) {
                    ...
                    e || (l.insertBefore(r, d[c ? 3 : 0] || null),
                    e = !0)
                }
                return e
            }
    ...
    K(f, "Core/Renderer/SVG/SVGLabel.js", [f["Core/Renderer/SVG/SVGElement.js"], f["Core/Utilities.js"]], function(a, f) {
        var C = this && this.__extends || function() {
            ...
            return function(k, e) {
                ...
                a(k, e);
                k.prototype = null === e ? Object.create(e) : (c.prototype = e.prototype,
                new c)
            }
        }()
          , H = f.defined
        ...
        return function(n) {
            ...
            k.prototype.paddingSetter = function(e, c) {
                E(e) ? e !== this[c] && (this[c] = e,
                this.updateTextPadding()) : this[c] = void 0
            }
            ;
            ...
            k.prototype.updateBoxSize = function() {
                ...
                this.needsBox && (this.box || (a = this.box = this.symbolKey ? this.renderer.symbol(this.symbolKey) : this.renderer.rect(),
            ...
            k.prototype.xSetter = function(e) {
                this.x = e;
                this.alignFactor && (e -= this.alignFactor * this.getPaddedWidth(),
        ...
        return function() {
            ...
            e.prototype.buildSVG = function() {
                ...
                if (x !== c.textCache) {
                    ...
                    for (x = f.length; x--; )
                        e.removeChild(f[x]);
                    q || this.ellipsis || this.width || -1 !== t.indexOf(" ") && (!this.noWrap || y.test(t)) ? "" !== t && (g && g.appendChild(e),
                    t = new a(t),
                    ...
                    g && g.removeChild(e)) : e.appendChild(C.createTextNode(this.unescapeEntities(t)));
            ...
            e.prototype.modifyDOM = function() {
                ...
                [].forEach.call(a.element.querySelectorAll("tspan.highcharts-br"), function(g, q) {
                    g.nextSibling && g.previousSibling && (0 === q && 1 === g.previousSibling.nodeType && (a.firstLineMetrics = a.renderer.fontMetrics(void 0, g.previousSibling)),
                    I(g, {
                ...
                if (q) {
                    var f = function(g, k) {
                        var m = g.textContent || ""
                          ...
                          , D = a.actualWidth;
                        if (c.ellipsis)
                            m && c.truncate(g, m, void 0, 0, Math.max(0, q - parseInt(c.fontSize || 12, 10)), function(b, d) {
                            ...
                            for (; h.length; )
                                h.length && !c.noWrap && 0 < d && (m.push(g.textContent || ""),
                                g.textContent = h.join(" ").replace(/- /g, "-")),
                                c.truncate(g, void 0, h, 0 === d ? D || 0 : 0, q, function(b, d) {
                      ...
                      , y = function(c) {
                        [].slice.call(c.childNodes).forEach(function(e) {
                            e.nodeType === E.Node.TEXT_NODE ? f(e, c) : (-1 !== e.className.baseVal.indexOf("highcharts-br") && (a.actualWidth = 0),
                            y(e))
                        })
                    };
                    y(a.element)
            ...
            e.prototype.modifyTree = function(c) {
                var a = this
                  , e = function(g, q) {
                    ...
                    if ("b" === f || "strong" === f)
                        m ? k["class"] = "highcharts-strong" : t.fontWeight = "bold";
                    else if ("i" === f || "em" === f)
                        m ? k["class"] = "highcharts-emphasized" : t.fontStyle = "italic";
                    t && t.color && (t.fill = t.color);
                    "br" === f ? (k["class"] = "highcharts-br",
                    g.textContent = "\u200b",
                    (q = c[q + 1]) && q.textContent && (q.textContent = q.textContent.replace(/^ +/gm, ""))) : "a" === f && p && p.some(function(c) {
                ...
                var g = this.svgElement, p = g.renderer, t = g.rotation, m = [], h = e ? 1 : 0, b = (a || e || "").length, l = b, d, D = function(b, d) {
                    ...
                    if (h && "undefined" === typeof m[d])
                        if (h.getSubStringLength)
                            ...
                            p.getSpanWidth && (c.textContent = f(a || e, b),
    ...
    K(f, "Core/Renderer/SVG/SVGRenderer.js", [f["Core/Renderer/HTML/AST.js"], f["Core/Color/Color.js"], f["Core/Globals.js"], f["Core/Renderer/RendererRegistry.js"], f["Core/Renderer/SVG/SVGElement.js"], f["Core/Renderer/SVG/SVGLabel.js"], f["Core/Renderer/SVG/Symbols.js"], f["Core/Renderer/SVG/TextBuilder.js"], f["Core/Utilities.js"]], function(a, f, B, H, w, E, I, A, u) {
        var n = B.charts, k = B.deg2rad, e = B.doc, c = B.isFirefox, p = B.isMS, g = B.isWebKit, t = B.noop, q = B.SVG_NS, F = B.symbolSizes, y = B.win, x = u.addEvent, z = u.attr, m = u.createElement, h = u.css, b = u.defined, l = u.destroyObjectProperties, d = u.extend, D = u.isArray, v = u.isNumber, r = u.isObject, O = u.isString, P = u.merge, S = u.pick, N = u.pInt, C = u.uniqueKey, X;
        B = function() {
            ...
            J.prototype.init = function(b, d, a, l, r, m, J) {
                ...
                ,
                d(),
                this.unSubPixelFix = x(y, "resize", d))
            }
            ;
            ...
            J.prototype.rect = function(b, d, c, a, h, e) {
                ...
                this.styledMode || ("undefined" !== typeof e && (b["stroke-width"] = e,
                b = l.crisp(b)),
                b.fill = "none");
                h && (b.r = h);
            ...
            J.prototype.image = function(b, d, c, a, h, e) {
                ...
                ;
                e ? (r(m.element, "data:image/gif;base64,R0lGODlhAQABAAAAACH5BAEKAAEALAAAAAABAAEAAAICTAEAOw=="),
                c = new y.Image,
                x(c, "load", d),
                c.src = b,
                c.complete && d({})) : r(m.element, b);
                return m
            }
            ;
            J.prototype.symbol = function(c, a, l, r, J, G) {
                var g = this, v = /^url\((.*?)\)$/, q = v.test(c), D = !q && (this.symbols[c] ? c : "circle"), k = D && this.symbols[D], f;
                if (k) {
                    ...
                    ["width", "height"].forEach(function(d) {
                        t[d + "Setter"] = function(d, c) {
                            var a = this["img" + c];
                            this[c] = d;
                            b(a) && (G && "within" === G.backgroundSize && this.width && this.height && (a = Math.round(a * Math.min(this.width / this.imgwidth, this.height / this.imgheight))),
                            this.element && this.element.setAttribute(c, a),
                            this.alignByTranslate || (d = ((this[c] || 0) - a) / 2,
                            this.attr("width" === c ? {
                                translateX: d
                            } : {
                                translateY: d
            ...
            J.prototype.text = function(d, c, a, h) {
                ...
                if (!h || this.forExport && !this.allowHTML)
                    d.xSetter = function(b, d, c) {
                        for (var a = c.getElementsByTagName("tspan"), h = c.getAttribute(d), l = 0, e; l < a.length; l++)
                            e = a[l],
            ...
            J.prototype.pathToSegments = function(b) {
                for (var d = [], c = [], a = {
                    ...
                    O(c[0]) && v(b[h]) && c.length === a[c[0].toUpperCase()] && b.splice(h, 0, c[0].replace("M", "L").replace("m", "l")),
                    "string" === typeof b[h] && (c.length && d.push(c.slice(0)),
                    c.length = 0),
                    c.push(b[h]);
                d.push(c.slice(0));
                return d
    ...
    K(f, "Core/Renderer/HTML/HTMLElement.js", [f["Core/Globals.js"], f["Core/Renderer/SVG/SVGElement.js"], f["Core/Utilities.js"]], function(a, f, B) {
        var C = this && this.__extends || function() {
            ...
            return function(a, e) {
                ...
                c(a, e);
                a.prototype = null === e ? Object.create(e) : (g.prototype = e.prototype,
                new g)
            }
        }()
          , w = a.isFirefox
        ...
        return function(a) {
            ...
            g.prototype.htmlUpdateTransform = function() {
                if (this.added) {
                    ...
                    if ("SPAN" === e.tagName) {
                        ...
                        D !== this.cTT && (v = a.fontMetrics(e.style.fontSize, e).b,
            ...
            g.prototype.setSpanRotation = function(c, a, e) {
                ...
                k && (g[k] = g.transform = "rotate(" + c + "deg)",
                g[k + (w ? "Origin" : "-origin")] = g.transformOrigin = 100 * a + "% " + e + "px",
                u(this.element, g))
            }
            ;
            g.composedClasses = [];
    ...
    K(f, "Core/Renderer/HTML/HTMLRenderer.js", [f["Core/Renderer/HTML/AST.js"], f["Core/Renderer/SVG/SVGElement.js"], f["Core/Renderer/SVG/SVGRenderer.js"], f["Core/Utilities.js"]], function(a, f, B, H) {
        ...
        return function(n) {
            ...
            k.compose = function(a) {
                -1 === k.composedClasses.indexOf(a) && (k.composedClasses.push(a),
                a.prototype.html = k.prototype.html);
                return a
            }
            ;
    ...
    K(f, "Core/Foundation.js", [f["Core/Utilities.js"]], function(a) {
        var f = a.addEvent, B = a.isFunction, H = a.objectEach, w = a.removeEvent, E;
        (function(a) {
            a.registerEventOptions = function(a, u) {
                a.eventOptions = a.eventOptions || {};
                H(u.events, function(n, k) {
                    a.eventOptions[k] !== n && (a.eventOptions[k] && (w(a, k, a.eventOptions[k]),
                    delete a.eventOptions[k]),
                    B(n) && (a.eventOptions[k] = n,
                    f(a, k, n)))
                })
            }
        }
    ...
    K(f, "Core/Axis/Tick.js", [f["Core/FormatUtilities.js"], f["Core/Globals.js"], f["Core/Utilities.js"]], function(a, f, B) {
        ...
        f = function() {
            ...
            g.prototype.addLabel = function() {
                ...
                var C = function(d) {
                    return b.formatter ? b.formatter.call(d, d) : b.format ? (d.text = e.defaultLabelFormatter.call(d),
                    a.format(b.format, d, f)) : e.defaultLabelFormatter.call(d, d)
                };
                g = C.call(N, N);
                var X = P && P.list;
            ...
            g.prototype.createLabel = function(c, a, g) {
                var k = this.axis
                  , f = k.chart;
                if (c = I(a) && g.enabled ? f.renderer.text(a, c.x, c.y, g.useHTML).add(k.labelGroup) : null)
            ...
            g.prototype.handleOverflow = function(c) {
                ...
                var h = this.label, b = this.rotation, l = {
                    left: 0,
                    center: .5,
                    right: 1
                }[a.labelAlign || h.attr("align")], d = h.getBBox().width, D = a.getSlotWidth(this), v = {}, r = D, n = 1, t;
                if (b || "justify" !== e.overflow)
                    0 > b && g - l * d < m ? t = Math.round(g / Math.cos(b * C) - m) : 0 < b && g + l * d > f && (t = Math.round((k - g) / Math.cos(b * C)));
                else if (k = g + (1 - l) * d,
                g - l * d < m ? r = c.x + r * (1 - l) - m : k > f && (r = f - c.x + r * l,
                n = -1),
                r = Math.min(D, r),
                r < D && "center" === a.labelAlign && (c.x += n * (D - r - l * (D - Math.min(d, r)))),
                d > r || a.autoRotation && (h.styles || {}).width)
                    t = r;
                t && (this.shortenLabel ? this.shortenLabel() : (v.width = Math.floor(t) + "px",
            ...
            g.prototype.moveLabel = function(a, e) {
                var g = this
                  ...
                  , p = f.reversed
                  , m = !1;
                k && k.textStr === a ? (g.movedLabel = k,
                m = !0,
                delete g.label) : c(f.ticks, function(b) {
                    m || b.isNew || b === g || !b.label || b.label.textStr !== a || (g.movedLabel = b.label,
                    m = !0,
            ...
            g.prototype.renderGridLine = function(c, a, e) {
                ...
                "minor" === this.type && (D = k.minorGridLineWidth,
                v = k.minorGridLineColor,
                r = k.minorGridLineDashStyle);
                d || (g.chart.styledMode || (f.stroke = v,
                f["stroke-width"] = D || 0,
                f.dashstyle = r),
                h || (f.zIndex = 1),
                c && (a = 0),
                this.gridLine = d = l.path().attr(f).addClass("highcharts-" + (h ? h + "-" : "") + "grid-line").add(g.gridGroup));
            ...
            g.prototype.renderMark = function(c, a, e) {
                ...
                var d = this.mark
                  , D = !d;
                h && (g.opposite && (h[0] = -h[0]),
                d || (this.mark = d = f.path().addClass("highcharts-" + (m ? m + "-" : "") + "tick").add(g.axisGroup),
                g.chart.styledMode || d.attr({
                    stroke: k,
                    "stroke-width": l
                })),
                d[D ? "attr" : "animate"]({
            ...
            g.prototype.renderLabel = function(c, a, e, g) {
                ...
                c = c.y;
                var D = !0;
                h && k(d) && (h.xy = c = this.getLabelPosition(d, c, h, q, b, f, g, l),
                this.isFirst && !this.isLast && !m.showFirstLabel || this.isLast && !this.isFirst && !m.showLastLabel ? D = !1 : !q || b.step || b.rotation || a || 0 === e || this.handleOverflow(c),
                l && g % l && (D = !1),
                D && k(c.y) ? (c.opacity = e,
                h[this.isNewLabel ? "attr" : "animate"](c).show(!0),
                this.isNewLabel = !1) : (h.hide(),
                this.isNewLabel = !0))
            }
            ;
    ...
    K(f, "Core/Axis/Axis.js", [f["Core/Animation/AnimationUtilities.js"], f["Core/Axis/AxisDefaults.js"], f["Core/Color/Color.js"], f["Core/DefaultOptions.js"], f["Core/Foundation.js"], f["Core/Globals.js"], f["Core/Axis/Tick.js"], f["Core/Utilities.js"]], function(a, f, B, H, w, E, I, A) {
        ...
        a = function() {
            ...
            a.prototype.init = function(d, c) {
                ...
                -1 === d.axes.indexOf(this) && (a ? d.axes.splice(d.xAxis.length, 0, this) : d.axes.push(this),
                        ...
                        if (e.visible || !c.options.chart.ignoreHiddenSeries) {
                            ...
                            if (d.isXAxis) {
                                ...
                                h.length) {
                                    ...
                                    var g = a.min;
                                    var m = a.max;
                                    b(g) || g instanceof Date || (h = h.filter(b),
                                    a = e.getXExtremes(h),
                                    g = a.min,
                                    m = a.max);
                                    h.length && (d.dataMin = Math.min(r(d.dataMin, g), g),
                                    d.dataMax = Math.max(r(d.dataMax, m), m))
                                }
                            } else if (e = e.applyExtremes(),
                            b(e.dataMin) && (g = e.dataMin,
                            d.dataMin = Math.min(r(d.dataMin, g), g)),
                            b(e.dataMax) && (m = e.dataMax,
                            d.dataMax = Math.max(r(d.dataMax, m), m)),
                            q(l) && (d.threshold = l),
            ...
            a.prototype.translate = function(d, c, a, e, h, l) {
                ...
                J -= k * (g.sector || g.len));
                c ? (l = (d * k + J - r) / e + m,
                h && (l = g.lin2val(l))) : (h && (d = g.val2lin(d)),
                d = k * (d - m) * e,
                l = b(m) ? (g.isRadial ? d : t(d)) + J + k * r + (b(l) ? e * l : 0) : void 0);
                return l
            }
            ;
            ...
            a.prototype.getPlotLinePath = function(d) {
                ...
                var a = this, e = a.chart, h = a.left, l = a.top, k = d.old, J = d.value, f = d.lineWidth, v = k && e.oldChartHeight || e.chartHeight, D = k && e.oldChartWidth || e.chartWidth, p = a.transB, q = d.translatedValue, n = d.force, t, z, y, O, P;
                d = {
                    value: J,
                    lineWidth: f,
                    old: k,
                ...
                m(this, "getPlotLinePath", d, function(d) {
                    ...
                    b(q) ? a.horiz ? (z = l,
                    O = v - a.bottom,
                    t = y = c(t, h, h + a.width)) : (t = h,
                    y = D - a.right,
                    z = O = c(z, l, l + a.height)) : (P = !0,
                    n = !1);
            ...
            a.prototype.getMinorTickPositions = function() {
                ...
                if (h && h / c < this.len / 3) {
                    ...
                    if (g)
                        ...
                        l = l.concat(this.getTimeTicks(this.dateTime.normalizeTimeTickInterval(c), e, a, b.startOfWeek));
                    else
            ...
            a.prototype.adjustForMinRange = function() {
                var b = this.options, d = this.logarithmic, a = this.min, e = this.max, h = 0, l, g, m, k;
            ...
            a.prototype.nameToX = function(b) {
                ...
                if (-1 === a) {
                    ...
                    e = a;
                "undefined" !== typeof e && (this.names[e] = b.name,
                ...
                (this.series || []).forEach(function(d) {
                    ...
                    d.data.forEach(function(c, a) {
                        if (c && c.options && "undefined" !== typeof c.name) {
                            var e = b.nameToX(c);
                            "undefined" !== typeof e && e !== c.x && (c.x = e,
                            d.xData[a] = e)
                        }
                    })
                }))
            ...
            a.prototype.setAxisTranslation = function() {
                ...
                if (e || a || h) {
                    var v = b.getClosest();
                    c ? (g = c.minPointOffset,
                    k = c.pointRangePadding) : b.series.forEach(function(d) {
                        var c = a ? 1 : e ? r(d.options.pointRange, v, 0) : b.axisPointRange || 0
                          , m = d.options.pointPlacement;
                        h = Math.max(h, c);
                        if (!b.single || a)
                            d = d.is("xrange") ? !e : e,
                            g = Math.max(g, d && l(m) ? 0 : c / 2),
                            k = Math.max(k, d && "on" === m ? 0 : c)
                    });
            ...
            a.prototype.setTickInterval = function(d) {
                ...
                a && (this.positiveValuesOnly && !d && 0 >= Math.min(this.min, r(this.dataMin, this.min)) && x(10, 1, c),
                ...
                !(k || this.axisPointRange || this.stacking && this.stacking.usePercentage || l) && q(this.min) && q(this.max) && (c = this.max - this.min) && (!q(n) && D && (this.min -= c * D),
                !q(z) && v && (this.max += c * v));
                b(this.userMin) || (b(e.softMin) && e.softMin < this.min && (this.min = n = e.softMin),
                b(e.floor) && (this.min = Math.max(this.min, e.floor)));
                b(this.userMax) || (b(e.softMax) && e.softMax > this.max && (this.max = z = e.softMax),
                b(e.ceiling) && (this.max = Math.min(this.max, e.ceiling)));
                f && q(this.dataMin) && (p = p || 0,
                !q(n) && this.min < p && this.dataMin >= p ? this.min = this.options.minRange ? Math.min(p, this.max - this.minRange) : p : !q(z) && this.max > p && this.dataMax <= p && (this.max = this.options.minRange ? Math.max(p, this.min + this.minRange) : p));
            ...
            a.prototype.setTickPositions = function() {
                ...
                if (!c) {
                    if (this.ordinal && this.ordinal.positions || !((this.max - this.min) / this.tickInterval > Math.max(2 * this.len, 200)))
                        if (this.dateTime)
                            c = this.getTimeTicks(this.dateTime.normalizeTimeTickInterval(this.tickInterval, b.units), this.min, this.max, b.startOfWeek, this.ordinal && this.ordinal.positions, this.closestPointRange, !0);
                        else if (this.logarithmic)
                            c = this.logarithmic.getLogTickPositions(this.tickInterval, this.min, this.max);
                        else
                            for (var l = b = this.tickInterval; l <= 2 * b; )
                                if (c = this.getLinearTickPositions(this.tickInterval, this.min, this.max),
            ...
            a.prototype.alignToOthers = function() {
                var d = this, c = [this], a = d.options, e = "yAxis" === this.coll && this.chart.options.chart.alignThresholds, h = [], l;
            ...
            a.prototype.getThresholdAlignment = function(d) {
                ...
                if (b(this.threshold))
                    return d = g((this.threshold - (this.dataMin || 0)) / ((this.dataMax || 0) - (this.dataMin || 0)), 0, 1),
                    ...
                    if (b(D) && b(d.threshold)) {
                        for (; l[D] !== f || l.length !== g || l[0] > e || l[l.length - 1] < a; ) {
                            ...
                            for (l.push(d.threshold); l.length < g; )
                                void 0 === l[D] || l[D] > d.threshold ? l.unshift(t(l[0] - v)) : l.push(t(l[l.length - 1] + v));
                        ...
                        for (; l.length < g; )
                            l.length % 2 || e === f ? l.push(t(l[l.length - 1] + v)) : l.unshift(t(l[0] - v));
                        m()
                    }
                    if (q(c)) {
                        for (v = f = l.length; v--; )
            ...
            a.prototype.setScale = function() {
                ...
                c || b || d || this.isLinked || this.forceRedraw || this.userMin !== (this.old && this.old.userMin) || this.userMax !== (this.old && this.old.userMax) || this.alignToOthers() ? (this.stacking && this.stacking.resetStacks(),
                this.forceRedraw = !1,
                this.getSeriesExtremes(),
                this.setTickInterval(),
                this.isDirty || (this.isDirty = c || this.min !== (this.old && this.old.min) || this.max !== (this.old && this.old.max))) : this.stacking && this.stacking.cleanStacks();
            ...
            a.prototype.zoom = function(b, d) {
                ...
                m(this, "zoom", b, function(b) {
                    var d = b.newMin
                      , h = b.newMax;
                    if (d !== c.min || h !== c.max)
                        c.allowZoomOutside || (q(a) && (d < l && (d = l),
                        d > g && (d = g)),
                        q(e) && (h < l && (h = l),
                        h > g && (h = g))),
                        c.displayBtn = "undefined" !== typeof d || "undefined" !== typeof h,
                        c.setExtremes(d, h, !1, void 0, {
                            trigger: "zoom"
                        });
                    b.zoomed = !0
                });
            ...
            a.prototype.unsquish = function() {
                var d = this.options.labels, c = this.horiz, a = this.tickInterval, h = this.len / (((this.categories ? 1 : 0) + this.max - this.min) / a), l = d.rotation, g = this.labelMetrics(), m = Math.max(this.max - this.min, 0), k = function(b) {
                    var d = b / (h || 1);
                    d = 1 < d ? Math.ceil(d) : 1;
                    d * a > m && Infinity !== b && Infinity !== h && m && (d = Math.ceil(m / a));
                    return t(d * a)
                }, v = a, f, D, p = Number.MAX_VALUE;
                if (c) {
            ...
            a.prototype.renderUnsquish = function() {
                ...
                if (this.autoRotation)
                    D > r && D > v.h ? k.rotation = this.labelRotation : this.labelRotation = 0;
                else if (m) {
                    var p = r;
                    if (!f) {
                        var q = "clip";
                ...
                k.rotation && (p = D > .5 * b.chartHeight ? .33 * b.chartHeight : D,
                f || (q = "ellipsis"));
                ...
                c.forEach(function(b) {
                    var d = (b = a[b]) && b.label
                      ...
                      , e = {};
                    d && (d.attr(k),
                    b.shortenLabel ? b.shortenLabel() : p && !c && "nowrap" !== h.whiteSpace && (p < d.textPxLength || "SPAN" === d.element.tagName) ? (e.width = p + "px",
                    f || (e.textOverflow = d.specificTextOverflow || q),
                    d.css(e)) : d.styles && d.styles.width && !e.width && !c && d.css({
                        width: null
                    }),
            ...
            a.prototype.addTitle = function(b) {
                ...
                this.axisTitle = c.text(h.text || "", 0, 0, h.useHTML).attr({
                    zIndex: 7,
                    rotation: h.rotation,
                    align: g
            ...
            a.prototype.getOffset = function() {
                var b = this
                  ...
                  , y = c.axisOffset;
                c = c.clipOffset;
                var O = [-1, 1, 1, -1][h], P = e.className, x, F = 0, fa = 0, ca = 0;
                ...
                r(z.reserveSpace, "center" === d.labelAlign ? !0 : null, d.reserveSpaceDefault) && g.forEach(function(b) {
                    ca = Math.max(l[b].getLabelSize(), ca)
                }),
                d.staggerLines && (ca *= d.staggerLines),
                d.labelOffset = ca * (d.opposite ? -1 : 1)) : v(l, function(b, d) {
                    b.destroy();
                    delete l[d]
                });
                if (t && t.text && !1 !== t.enabled && (d.addTitle(x),
                x && !1 !== t.reserveSpace)) {
                ...
                "colorAxis" !== k && (a = this.tickSize("tick"),
                y[h] = Math.max(y[h], (d.axisTitleMargin || 0) + F + O * d.offset, n, g && g.length && a ? a[0] + O * d.offset : 0),
                e = !d.axisLine || e.offset ? 0 : 2 * Math.floor(d.axisLine.strokeWidth() / 2),
                c[p] = Math.max(c[p], e));
            ...
            a.prototype.render = function() {
                var d = this, c = d.chart, a = d.logarithmic, e = d.options, h = d.isLinked, l = d.tickPositions, g = d.axisTitle, r = d.ticks, k = d.minorTicks, f = d.alternateBands, D = e.stackLabels, p = e.alternateGridColor, q = d.tickmarkOffset, n = d.axisLine, t = d.showAxis, z = u(c.renderer.globalAnimation), y, O;
                ...
                if (d.hasData() || h) {
                    ...
                    q && (0 === d.min || d.single) && (r[-1] || (r[-1] = new I(d,-1,null,!0)),
                    r[-1].render(-1)));
                    p && l.forEach(function(b, e) {
                        O = "undefined" !== typeof l[e + 1] ? l[e + 1] + q : d.max - q;
                        0 === e % 2 && b < d.max && O <= d.max + (c.polar ? -q : q) && (f[b] || (f[b] = new E.PlotLineOrBand(d)),
                        y = b + q,
                        f[b].options = {
                    ...
                    d._addedPlotLB || (d._addedPlotLB = !0,
                ...
                [r, k, f].forEach(function(b) {
                    var d = []
                      , a = z.duration;
                    v(b, function(b, c) {
                        b.isActive || (b.render(c, !1, 0),
                        b.isActive = !1,
                        d.push(c))
                    });
                    N(function() {
                        for (var c = d.length; c--; )
                            b[d[c]] && !b[d[c]].isActive && (b[d[c]].destroy(),
                            delete b[d[c]])
                ...
                n.isPlaced = !0,
                n[t ? "show" : "hide"](t));
                g && t && (e = d.getTitlePosition(),
                g[g.isNew ? "attr" : "animate"](e),
                g.isNew = !1);
            ...
            a.prototype.drawCrosshair = function(b, d) {
                var c = this.crosshair, a = r(c && c.snap, !0), e = this.chart, h, l = this.cross;
    ...
    K(f, "Core/Axis/DateTimeAxis.js", [f["Core/Utilities.js"]], function(a) {
        var f = a.addEvent, B = a.getMagnitude, H = a.normalizeTickInterval, w = a.timeUnits, E;
        (function(a) {
            function A() {
            ...
            var k = function() {
                ...
                a.prototype.normalizeTimeTickInterval = function(c, a) {
                    ...
                    a = e[e.length - 1];
                    var k = w[a[0]], f = a[1], p;
                    for (p = 0; p < e.length && !(a = e[p],
                    k = w[a[0]],
                    f = a[1],
                    e[p + 1] && c <= (k * f[f.length - 1] + w[e[p + 1][0]]) / 2); p++)
                        ;
    ...
    K(f, "Core/Axis/LogarithmicAxis.js", [f["Core/Utilities.js"]], function(a) {
        var f = a.addEvent, B = a.normalizeTickInterval, H = a.pick, w;
        (function(a) {
            function w(a) {
            ...
            var n = function() {
                ...
                a.prototype.getLogTickPositions = function(a, c, k, g) {
                    ...
                    if (.5 <= a)
                        ...
                        var x = Math.floor(c), z, m = p = void 0;
                        ...
                        c = this.lin2log(c),
                        k = this.lin2log(k),
                        a = g ? e.getMinorTickInterval() : p.tickInterval,
                        a = H("auto" === a ? null : a, this.minorAutoInterval, p.tickPixelInterval / (g ? 5 : 1) * (k - c) / ((g ? f / e.tickPositions.length : f) || 1)),
                        a = B(a),
                        n = e.getLinearTickPositions(a, c, k).map(this.log2lin),
    ...
    K(f, "Core/Axis/PlotLineOrBand/PlotLineOrBandAxis.js", [f["Core/Utilities.js"]], function(a) {
        var f = a.erase, B = a.extend, H = a.isNumber, w;
        (function(a) {
            var w = [], A;
            a.compose = function(a, k) {
                A || (A = a);
                -1 === w.indexOf(k) && (w.push(k),
                B(k.prototype, u.prototype));
                return k
            }
            ;
            var u = function() {
                    ...
                    if (a && k) {
                        ...
                        for (e = 0; e < a.length; e += 2) {
                            var n = a[e]
                              ...
                              , x = k[e]
                              , z = k[e + 1];
                            "M" !== n[0] && "L" !== n[0] || "M" !== y[0] && "L" !== y[0] || "M" !== x[0] && "L" !== x[0] || "M" !== z[0] && "L" !== z[0] || (f && x[1] === n[1] ? (x[1] += c,
                            z[1] += c) : f || x[2] !== n[2] || (x[2] += c,
                            z[2] += c),
                            g.push(["M", n[1], n[2]], ["L", y[1], y[2]], ["L", z[1], z[2]], ["L", x[1], x[2]], ["Z"]));
                            g.isFlat = q
                        }
                    }
                    return g
    ...
    K(f, "Core/Axis/PlotLineOrBand/PlotLineOrBand.js", [f["Core/Axis/PlotLineOrBand/PlotLineOrBandAxis.js"], f["Core/Utilities.js"]], function(a, f) {
        ...
        f = function() {
            ...
            e.prototype.render = function() {
                ...
                l = f.log2lin(l),
                D = f.log2lin(D));
                a.chart.styledMode || (r ? (S.stroke = F || "#999999",
                S["stroke-width"] = k(q.width, 1),
                q.dashStyle && (S.dashstyle = q.dashStyle)) : O && (S.fill = F || "#e6ebf5",
                q.borderWidth && (S.stroke = q.borderColor,
                S["stroke-width"] = q.borderWidth)));
                z.zIndex = y;
                N += "-" + y;
                ...
                this.renderLabel(h, r, O, y)) : b && b.hide();
                return c
            }
            ;
    ...
    K(f, "Core/Tooltip.js", [f["Core/FormatUtilities.js"], f["Core/Globals.js"], f["Core/Renderer/RendererUtilities.js"], f["Core/Renderer/RendererRegistry.js"], f["Core/Utilities.js"]], function(a, f, B, H, w) {
        ...
        a = function() {
            ...
            a.prototype.getAnchor = function(b, a) {
                var d = this.chart, c = d.pointer, e = d.inverted, h = d.plotTop, l = d.plotLeft, g, m, f = 0, k = 0;
                b = z(b);
                this.followPointer && a ? ("undefined" === typeof a.chartX && (a = c.normalize(a)),
                c = [a.chartX - l, a.chartY - h]) : b[0].tooltipPos ? c = b[0].tooltipPos : (b.forEach(function(b) {
                    g = b.series.yAxis;
                    m = b.series.xAxis;
                    f += b.plotX || 0;
                    k += b.plotLow ? (b.plotLow + (b.plotHigh || 0)) / 2 : b.plotY || 0;
                    m && g && (e ? (f += h + d.plotHeight - m.len - m.pos,
                    k += l + d.plotWidth - g.len - g.pos) : (f += m.pos - l,
                    k += g.pos - h))
                }),
                f /= b.length,
                k /= b.length,
                c = [e ? d.plotWidth - k : f, e ? d.plotHeight - f : k],
                this.shared && 1 < b.length && a && (e ? c[0] = a.chartX - l : c[1] = a.chartY - h));
                return c.map(Math.round)
            }
            ;
            a.prototype.getLabel = function() {
                var b = this, a = this.chart.styledMode, d = this.options, c = this.split && this.allowShared, h = "tooltip" + (e(d.className) ? " " + d.className : ""), g = d.style.pointerEvents || (!this.followPointer && d.stickOnContact ? "auto" : "none"), m = function() {
                    b.inContact = !0
                }, p = function(d) {
                ...
                var t = !this.followPointer && x(d.ttBelow, !c.inverted === p)
                  , y = function(b, d, a, c, m, f, r) {
                    ...
                    if (t && p)
                        ...
                        h[b] = Math.min(r - c, 0 > n - l ? n : n - l);
                    else if (p)
                        h[b] = Math.max(f, m + l + a > d ? m : m + l);
                    else
                        return !1
                }
                  ...
                  , T = function() {
                    !1 !== y.apply(0, n) ? !1 !== F.apply(0, q) || z || (G(!0),
                    T()) : z ? h.x = h.y = 0 : (G(!0),
                    T())
                };
            ...
            a.prototype.move = function(b, a, d, c) {
                ...
                e.getLabel().attr(h);
                e.drawTracker();
                l && (w.clearTimeout(this.tooltipTimeout),
            ...
            a.prototype.refresh = function(b, a) {
                ...
                if (c.enabled && h.series) {
                    ...
                    var n = b[0]
                      , q = b[1];
                    f && this.allowShared ? (d.pointer.applyInactiveState(e),
                    ...
                    if (!1 === m)
                        ...
                        if (this.split && this.allowShared)
                            ...
                            var y = n
                              , F = q;
                            a && d.pointer.isDirectTouch && (y = a.chartX - d.plotLeft,
                            ...
                            if (d.polar || !1 === f.options.clip || e.some(function(b) {
                                ...
                                a.removeClass(/highcharts-color-[\d]+/g).addClass("highcharts-color-" + x(h.colorIndex, f.colorIndex)),
                                k || a.attr({
            ...
            a.prototype.renderSplit = function(b, a) {
                function d(b, d, a, e, h) {
                    void 0 === h && (h = !0);
                    a ? (d = Z ? 0 : E,
                    b = n(b - e / 2, M.left, M.right - e - (c.outside ? R : 0))) : (d -= B,
                    b = h ? b - e - C : b + C,
                    b = n(b, h ? b : M.left, M.right));
                    return {
                        x: b,
                        y: d
                    }
                ...
                b = b.slice(0, a.length + 1).reduce(function(b, e, h) {
                    if (!1 !== e && "" !== e) {
                        ...
                        w || (r.fill = G.backgroundColor,
                        r["stroke-width"] = G.borderWidth),
                        r = W.label("", 0, 0, G[v ? "headerShape" : "shape"], void 0, void 0, G.useHTML).addClass((v ? "highcharts-tooltip-header " : "") + "highcharts-tooltip-box " + p).attr(r).add(V));
                        r.isActive = !0;
                        r.attr({
                            text: e
                        });
                        ...
                        "number" === typeof q ? (v = v.height + 1,
                        p = T ? T.call(c, e, v, h) : d(D, q, l, e),
                        b.push({
                            align: T ? 0 : void 0,
                            anchorX: D,
                            anchorY: q,
            ...
            a.prototype.drawTracker = function() {
                if (this.followPointer || !this.options.stickOnContact)
                    ...
                    if (a && d) {
                        ...
                        this.tracker ? this.tracker.attr(c) : (this.tracker = a.renderer.rect(c).addClass("highcharts-tracker").add(a),
            ...
            a.prototype.styledModeFormat = function(b) {
                return b.replace('style="font-size: 0.625em"', 'class="highcharts-header"').replace(/style="color:{(point|series)\.color}"/g, 'class="highcharts-color-{$1.colorIndex}"')
            }
            ;
    ...
    K(f, "Core/Series/Point.js", [f["Core/Renderer/HTML/AST.js"], f["Core/Animation/AnimationUtilities.js"], f["Core/DefaultOptions.js"], f["Core/FormatUtilities.js"], f["Core/Utilities.js"]], function(a, f, B, H, w) {
        ...
        f = function() {
            ...
            l.prototype.destroy = function() {
                ...
                var l = e.hoverPoints, g = C(a.series.chart.renderer.globalAnimation), f;
                a.legendItem && e.legend.destroyItem(a);
                l && (a.setState(),
                k(l, a),
                l.length || (e.hoverPoints = null));
                if (a === e.hoverPoint)
                    a.onMouseOut();
                c && c.enabled ? (this.animateBeforeDestroy(),
                m(b, g.duration)) : b();
                e.pointCount--
            }
            ;
            ...
            l.prototype.getNestedProperty = function(b) {
                if (b)
                    return 0 === b.indexOf("custom.") ? p(b, this.options) : this[b]
            }
            ;
            ...
            l.prototype.optionsToObject = function(b) {
                ...
                if (q(b) || null === b)
                    ...
                    for (!a && b.length > e && (d = typeof b[0],
                    "string" === d ? h.name = b[0] : "number" === d && (h.x = b[0]),
                    m++); f < e; )
                        a && "undefined" === typeof b[m] || (0 < c[f].indexOf(".") ? l.prototype.setNestedProperty(h, b[m], c[f]) : h[c[f]] = b[m]),
                        m++,
                        f++;
                else
                    "object" === typeof b && (h = b,
            ...
            l.prototype.update = function(b, a, c, e) {
                function d() {
                    ...
                    d = null === h.y ? !d : d;
                    g && d && (h.graphic = g.destroy(),
                    delete h.hasDummyGraphic);
                    F(b, !0) && (g && g.element && b && b.marker && "undefined" !== typeof b.marker.symbol && (h.graphic = g.destroy()),
                ...
                var h = this, l = h.series, g = h.graphic, m = l.chart, f = l.options, k;
                a = z(a, !0);
            ...
            l.prototype.select = function(b, a) {
                ...
                d.firePointEvent(b ? "select" : "unselect", {
                    ...
                    a || e.getSelectedPoints().forEach(function(b) {
                        var a = b.series;
                        b.selected && b !== d && (b.selected = b.options.selected = !1,
            ...
            l.prototype.setState = function(b, h) {
                var d = this.series, l = this.state, g = d.options.states[b || "normal"] || {}, m = I.plotOptions[d.type].marker && d.options.marker, f = m && !1 === m.enabled, k = m && m.states && m.states[b || "normal"] || {}, p = !1 === k.enabled, n = this.marker || {}, D = d.chart, y = m && d.markerAttribs, t = d.halo, x, F = d.stateMarkerGraphic;
                b = b || "";
                        ...
                        if (b && k) {
                            ...
                            if (x)
                                if (F)
                                    ...
                                    l && (d.stateMarkerGraphic = F = D.renderer.symbol(l, x.x, x.y, x.width, x.height).add(d.markerGroup),
                                    F.currentSymbol = l);
                            !D.styledMode && F && "inactive" !== this.state && F.attr(d.pointAttribs(this, b))
                        }
                        F && (F[b && this.isInside ? "show" : "hide"](),
    ...
    K(f, "Core/Pointer.js", [f["Core/Color/Color.js"], f["Core/Globals.js"], f["Core/Tooltip.js"], f["Core/Utilities.js"]], function(a, f, B, H) {
        ...
        a = function() {
            ...
            a.prototype.destroy = function() {
                ...
                this.eventsToUnbind = [];
                f.chartCount || (a.unbindDocumentMouseUp && (a.unbindDocumentMouseUp = a.unbindDocumentMouseUp()),
            ...
            a.prototype.getHoverData = function(a, e, b, l, d, g) {
                ...
                f.forEach(function(b) {
                    ...
                    t(d) && (b.chart.isBoosting && (d = b.getPoint(d)),
                    h.push(d))
                })) : h.push(k));
                m = {
                    hoverPoint: k
            ...
            a.prototype.onContainerClick = function(a) {
                ...
                c.hoverPoint && b.firePointEvent("click", a)) : (e(a, this.getCoordinates(a)),
                c.isInsidePlot(a.chartX - l, a.chartY - d, {
                    visiblePlotOnly: !0
                }) && p(c, "click", a)))
            }
            ;
            ...
            a.prototype.onContainerMouseLeave = function(c) {
                ...
                b && b.shouldStickOnContact() && this.inClass(c.relatedTarget, "highcharts-tooltip-container") || (c = this.normalize(c),
                e && (c.relatedTarget || c.toElement) && (e.pointer.reset(),
            ...
            a.prototype.pinch = function(a) {
                ...
                f.x = [l[0].chartX, l[1] && l[1].chartX],
                f.y = [l[0].chartY, l[1] && l[1].chartY],
            ...
            a.prototype.pinchTranslateDirection = function(a, c, b, e, d, g, f, k) {
                ...
                ;
                var x, G, z = k || 1, M = b[0][r], F = !D && b[1][r];
                c();
                b = G;
                if (b < v.min) {
                    b = v.min;
            ...
            a.prototype.reset = function(a, c) {
                ...
                if (a)
                    g && f && x(f).length && (g.refresh(f),
                    g.shared && h ? h.forEach(function(b) {
            ...
            a.prototype.runPointActions = function(e, h) {
                ...
                if (f && (f !== b.hoverPoint || g && g.isHidden)) {
                    ...
                    h && g && !g.isHidden && (d = g.getAnchor([{}], e),
                    b.isInsidePlot(d[0], d[1], {
                        visiblePlotOnly: !0
                    }) && g.updatePosition({
                        plotX: d[0],
                        plotY: d[1]
    ...
    K(f, "Core/MSPointer.js", [f["Core/Globals.js"], f["Core/Pointer.js"], f["Core/Utilities.js"]], function(a, f, B) {
        ...
        function w(a, c, e, g) {
            ...
            "touch" !== a.pointerType && a.pointerType !== a.MSPOINTER_TYPE_TOUCH || !k || (k = k.pointer,
            g(a),
            k[c]({
                type: e,
    ...
    K(f, "Core/Legend/Legend.js", [f["Core/Animation/AnimationUtilities.js"], f["Core/FormatUtilities.js"], f["Core/Globals.js"], f["Core/Series/Point.js"], f["Core/Renderer/RendererUtilities.js"], f["Core/Utilities.js"]], function(a, f, B, H, w, E) {
        ...
        E = function() {
            ...
            a.prototype.setOptions = function(b) {
                var a = z(b.padding, 8);
                this.options = b;
                this.chart.styledMode || (this.itemStyle = b.itemStyle,
            ...
            a.prototype.colorizeItem = function(b, a) {
                ...
                if (!this.chart.styledMode) {
                    ...
                    h && (f && h.isMarker && (k = b.pointAttribs(),
                    a || (k.stroke = k.fill = g)),
                    h.attr(k))
                }
            ...
            a.prototype.positionItem = function(b) {
                ...
                ,
                g(f.translateY) ? f.animate(c, void 0, e) : (f.attr(c),
                e()));
                l && (l.x = d,
                l.y = h)
            }
            ...
            a.prototype.renderItem = function(b) {
                ...
                b.legendItem = G = d.text("", k ? e + h : -h, this.baseline || 0, t),
                a.styledMode || G.css(x(b.visible ? g : l)),
                G.attr({
                    align: k ? "left" : "right",
                    zIndex: 2
                }).add(b.legendGroup),
                this.baseline || (this.fontMetrics = d.fontMetrics(a.styledMode ? 12 : g.fontSize, G),
                ...
                c.squareSymbol && (this.symbolWidth = z(c.symbolWidth, Math.max(this.symbolHeight, 16)),
                n = this.symbolWidth + h + f + (q ? 20 : 0),
                k && G.attr("x", this.symbolWidth + h))),
                p.drawLegendSymbol(this, b),
                this.setItemEvents && this.setItemEvents(b, G, t));
            ...
            a.prototype.layoutItem = function(b) {
                ...
                d && this.itemX - c + a > f && (this.itemX = c,
                ...
                d ? this.itemX += a : (this.itemY += g + e + h,
            ...
            a.prototype.proximatePositions = function() {
                ...
                this.allItems.forEach(function(d) {
                    ...
                    if (d.yAxis) {
                        ...
                        d.visible ? (e = e ? e.plotY : d.yAxis.height,
                        e += g - .3 * h) : e = g + d.yAxis.height;
                        a.push({
                            target: e,
                            size: h,
                            item: d
            ...
            a.prototype.render = function() {
                ...
                if (0 < g && 0 < p)
                    l[l.placed ? "animate" : "attr"](l.crisp.call({}, {
                        x: 0,
                        y: 0,
                        width: g,
                        height: p
            ...
            a.prototype.handleOverflow = function(b) {
                var a = this, c = this.chart, d = c.renderer, e = this.options, h = e.y, g = "top" === e.verticalAlign, f = this.padding, l = e.maxHeight, k = e.navigation, m = z(k.animation, !0), p = k.arrowSize || 12, n = this.pages, q = this.allItems, t = function(b) {
                ...
                l && (h = Math.min(h, l));
                n.length = 0;
                b && 0 < h && b > h && !1 !== k.enabled ? (this.clipHeight = G = Math.max(h - 20 - this.titleHeight - f, 0),
                ...
                q.forEach(function(b, a) {
                    ...
                    b.pageIx = e - 1;
                    x && (q[a - 1].pageIx = e - 1);
                    a === q.length - 1 && c + d - n[e - 1] > G && d <= G && (n.push(c),
                    b.pageIx = e);
                    c !== x && (x = c)
                }),
                F || (F = a.clipRect = d.clipRect(0, f, 9999, 0),
                a.contentGroup.clip(F)),
                t(G),
    ...
    K(f, "Core/Series/SeriesRegistry.js", [f["Core/Globals.js"], f["Core/DefaultOptions.js"], f["Core/Series/Point.js"], f["Core/Utilities.js"]], function(a, f, B, H) {
        var w = f.defaultOptions, C = H.error, I = H.extendClass, A = H.merge, u;
        (function(f) {
            function k(a, c) {
                var e = w.plotOptions || {}
                  , g = c.defaultOptions;
            ...
            f.seriesType = function(a, c, p, g, n) {
                ...
                c = c || "";
                e[a] = A(e[c], p);
                k(a, I(f.seriesTypes[c] || function() {}
                , g));
    ...
    K(f, "Core/Chart/Chart.js", [f["Core/Animation/AnimationUtilities.js"], f["Core/Axis/Axis.js"], f["Core/FormatUtilities.js"], f["Core/Foundation.js"], f["Core/Globals.js"], f["Core/Legend/Legend.js"], f["Core/MSPointer.js"], f["Core/DefaultOptions.js"], f["Core/Pointer.js"], f["Core/Renderer/RendererRegistry.js"], f["Core/Series/SeriesRegistry.js"], f["Core/Renderer/SVG/SVGRenderer.js"], f["Core/Time.js"], f["Core/Utilities.js"], f["Core/Renderer/HTML/AST.js"]], function(a, f, B, H, w, E, I, A, u, n, k, e, c, p, g) {
        ...
        a = function() {
            ...
            a.prototype.getArgs = function(b, a, c) {
                V(b) || b.nodeName ? (this.renderTo = b,
                this.init(a, c)) : this.init(b, a)
            }
            ;
            a.prototype.init = function(b, a) {
                var e = b.plotOptions || {};
            ...
            a.prototype.isInsidePlot = function(b, a, c) {
                ...
                var d = this.inverted
                  ...
                  , l = 0;
                var k = 0;
                c.visiblePlotOnly && this.scrollingContainer && (k = this.scrollingContainer,
                l = k.scrollLeft,
                k = k.scrollTop);
                var m = c.series;
                ...
                c = c.paneCoordinates ? d.pos + a : g + a,
                c >= Math.max(k + g, d.pos) && c <= Math.min(k + g + e.height, d.pos + d.len) || (b.isInsidePlot = !1));
            ...
            a.prototype.redraw = function(b) {
                ...
                c.forEach(function(b) {
                    b.isDirty && ("point" === b.options.legendType ? ("function" === typeof b.updateTotals && b.updateTotals(),
                    m = !0) : h && (h.labelFormatter || h.labelFormat) && (m = !0));
                    b.isDirtyData && Q(b, "updatedData")
                });
                m && e && e.options.enabled && (e.render(),
            ...
            a.prototype.temporaryDisplay = function(b) {
                ...
                if (b)
                    for (; a && a.style; )
                        a.hcOrigStyle && (N(a, a.hcOrigStyle),
                        delete a.hcOrigStyle),
                        a.hcOrigDetached && (m.body.removeChild(a),
                        a.hcOrigDetached = !1),
                        a = a.parentNode;
                else
                    for (; a && a.style; ) {
                        m.body.contains(a) || a.parentNode || (a.hcOrigDetached = !0,
            ...
            a.prototype.getContainer = function() {
                var a = this.options, c = a.chart, d = ka(), h, f = this.renderTo;
            ...
            a.prototype.setChartSize = function(b) {
                var a = this.inverted, c = this.renderer, d = this.chartWidth, e = this.chartHeight, h = this.options.chart, g = this.spacing, f = this.clipOffset, l, k, m, p;
            ...
            a.prototype.drawChartBox = function() {
                ...
                l && (h ? (l !== h.attr("href") && h.attr("href", l),
                h.animate(n)) : this.plotBGImage = a.image(l, k, m, p, G).add()));
                q ? q.animate({
                    width: r.width,
                    height: r.height
                ...
                x = "animate";
                y || (x = "attr",
                this.plotBorder = y = a.rect().addClass("highcharts-plot-border").attr({
                    zIndex: 1
                }).add());
                e || y.attr({
            ...
            a.prototype.propFromSeries = function() {
                var b = this, a = b.options.chart, c = b.options.series, d, e, h;
            ...
            a.prototype.linkSeries = function() {
                ...
                a.forEach(function(a) {
                    ...
                    V(c) && (c = ":previous" === c ? b.series[a.index - 1] : b.get(c)) && c.linkedParent !== a && (c.linkedSeries.push(a),
                    a.linkedParent = c,
            ...
            ;
            a.prototype.destroy = function() {
                var b = this, a = b.axes, c = b.series, d = b.container, e = d && d.parentNode, h;
                Q(b, "destroy");
            ...
            a.prototype.update = function(b, a, d, e) {
                ...
                b.time && (this.time === D && (this.time = new c(b.time)),
                ...
                Z(b, function(a, c) {
                    if (h[c] && "function" === typeof h[c].update)
                        ...
                        "colors" !== c && -1 === h.collectionsWithUpdate.indexOf(c) && W(!0, h.options[c], b[c]);
            ...
            a.prototype.zoom = function(b) {
                var a = this, c = a.pointer, d = a.inverted ? c.mouseDownX : c.mouseDownY, e = !1, h;
                ...
                c.initiated = !1) : b.xAxis.concat(b.yAxis).forEach(function(b) {
                    ...
                    if (!k && d >= f && d <= l || k || !Y(d))
                        m = !0;
                    c[k ? "zoomX" : "zoomY"] && m && (h = g.zoom(b.min, b.max),
                    g.displayBtn && (e = !0))
                });
                    ...
                    a.forEach(function(a) {
                        if (a.options.panningEnabled && !a.options.isInternal) {
                            ...
                            !p || a.isXAxis || t && !t.isDirty || a.series.forEach(function(b) {
                                ...
                                T(a.dataMin) && T(a.dataMax) && (t.startMin = Math.min(R(b.options.threshold, Infinity), a.dataMin, t.startMin),
                            ...
                            0 < m && (n = q,
                            k -= m),
                            a.series.length && k !== G.min && n !== G.max && k >= p && n <= q && (a.setExtremes(k, n, !1, !1, {
                                trigger: "pan"
                            }),
                            c.resetZoomButton || h || k === p || n === q || !g.match("y") || (c.showResetZoom(),
                            a.displayBtn = !1),
                            f = !0),
                            e[d] = l)
                        }
    ...
    K(f, "Core/Legend/LegendSymbol.js", [f["Core/Utilities.js"]], function(a) {
        ...
        (function(a) {
            a.drawLineMarker = function(a) {
                ...
                p && !1 !== p.enabled && A && (w = Math.min(B(p.radius, n), n),
    ...
    K(f, "Core/Series/Series.js", [f["Core/Animation/AnimationUtilities.js"], f["Core/DefaultOptions.js"], f["Core/Foundation.js"], f["Core/Globals.js"], f["Core/Legend/LegendSymbol.js"], f["Core/Series/Point.js"], f["Core/Series/SeriesDefaults.js"], f["Core/Series/SeriesRegistry.js"], f["Core/Renderer/SVG/SVGElement.js"], f["Core/Utilities.js"]], function(a, f, B, H, w, E, I, A, u, n) {
        ...
        a = function() {
            ...
            a.prototype.bindAxes = function() {
                var b = this, a = b.options, c = b.chart, d;
            ...
            a.prototype.autoIncrement = function(b) {
                var a = this.options, c = a.pointIntervalUnit, d = a.relativeXValue, e = this.chart.time, h = this.xIncrement, g;
                h = L(h, a.pointStart, 0);
                this.pointInterval = g = L(this.pointInterval, a.pointInterval, 1);
                d && N(b) && (g *= b);
                c && (a = new e.Date(h),
                "day" === c ? e.set("Date", a, e.get("Date", a) + g) : "month" === c ? e.set("Month", a, e.get("Month", a) + g) : "year" === c && e.set("FullYear", a, e.get("FullYear", a) + g),
                g = a.getTime() - h);
                if (d && N(b))
                    return h + g;
                this.xIncrement = h + g;
            ...
            a.prototype.setOptions = function(b) {
                ...
                a || (d.color = h.negativeColor,
                d.fillColor = h.negativeFillColor),
                e.push(d));
            ...
            a.prototype.findPointIndex = function(b, a) {
                var c = b.id, d = b.x, e = this.points, h = this.options.dataSorting, g, f;
                if (c)
                    h = this.chart.get(c),
                    h instanceof E && (g = h);
            ...
            a.prototype.updateData = function(b, a) {
                var c = this.options, d = c.dataSorting, e = this.points, h = [], g = this.requireSorting, f = b.length === e.length, k, m, p, n = !0;
                ...
                b.forEach(function(b, a) {
                    var m = l(b) && this.pointClass.prototype.optionsToObject.call({
                      ...
                      , n = m.x;
                    if (m.id || N(n)) {
                        if (m = this.findPointIndex(m, p),
                        -1 === m || "undefined" === typeof m ? h.push(b) : e[m] && b !== c.data[m] ? (e[m].update(b, !1, null, !1),
                        e[m].touched = !0,
                        g && (p = m + 1)) : e[m] && (e[m].touched = !0),
                ...
                if (k)
                    ...
                    !f || d && d.enabled ? n = !1 : (b.forEach(function(b, a) {
            ...
            a.prototype.setData = function(b, a, c, d) {
                ...
                "point" === f.legendType && (this.processData(),
                this.generatePoints());
                a && l.redraw(c)
            }
            ;
            ...
            a.prototype.getProcessedData = function(b) {
                ...
                for (d = f.length || 1; --d; )
                    if (a = c ? b(f[d]) - b(f[d - 1]) : f[d] - f[d - 1],
                    0 < a && ("undefined" === typeof G || a < G))
                        var G = a;
                    else
                        0 > a && k && !m && (D(15, !1, this.chart),
                        k = !1);
                return {
                    xData: f,
                    yData: l,
            ...
            a.prototype.generatePoints = function() {
                ...
                for (p = 0; p < h; p++) {
                    ...
                    if (f) {
                        ...
                        (r = n[q]) || "undefined" === typeof a[q] || (n[q] = r = (new e).init(this, a[q], c[p]));
                    r && (r.index = f ? b + p : q,
                    k[p] = r)
                }
                this.options.keys = l;
            ...
            a.prototype.translate = function() {
                ...
                this.generatePoints();
                var a = this.options, c = a.stacking, d = this.xAxis, e = d.categories, h = this.enabledDataSorting, g = this.yAxis, f = this.points, k = f.length, p = this.pointPlacementToXValue(), n = !!p, q = a.threshold, r = a.startFromThreshold ? q : 0, t = this.zoneAxis || "y", y, z, x = Number.MAX_VALUE;
                for (y = 0; y < k; y++) {
                    var v = f[y]
                      , F = v.x
                      , u = void 0
            ...
            a.prototype.animate = function(b) {
                ...
                if (b && c)
                    h = this.getClipBox(),
                    f ? f.attr("height", h.height) : (h.width = 0,
                    e && (h.x = a.plotHeight),
            ...
            a.prototype.afterAnimate = function() {
                ...
                J(this.chart.sharedClips, function(a, c, d) {
                    a && !b.chart.container.querySelector('[clip-path="url(#' + a.id + ')"]') && (a.destroy(),
                    delete d[c])
                });
            ...
            a.prototype.drawPoints = function() {
                var b = this.points, a = this.chart, c = this.options.marker, d = this[this.specialGroup] || this.markerGroup, e = this.xAxis, h = L(c.enabled, !e || e.isRadial ? !0 : null, this.closestPointRangePx >= c.enabledThreshold * c.radius), g, f;
                if (!1 !== c.enabled || this._hasPointMarkers)
                    for (g = 0; g < b.length; g++) {
                        ...
                        if ((h && "undefined" === typeof m.enabled || m.enabled) && !l.isNull && !1 !== l.visible) {
                            ...
                            var r = !1 !== l.isInside;
                            f ? f[r ? "show" : "hide"](r).animate(q) : r && (0 < (q.width || 0) || l.hasImage) && (l.graphic = f = a.renderer.symbol(n, q.x, q.y, q.width, q.height, p ? m : c).add(d),
                            this.enabledDataSorting && a.hasRendered && (f.attr({
                                x: l.startXPos
                            }),
                            k = "animate"));
            ...
            ;
            a.prototype.destroy = function(b) {
                var a = this, c = a.chart, e = /AppleWebKit\/533/.test(q.navigator.userAgent), h = a.data || [], g, f, l, k;
                C(a, "destroy", {
                    keepEventsForUpdate: b
                });
                this.removeEvents(b);
                (a.axisTypes || []).forEach(function(b) {
                    (k = a[b]) && k.series && (d(k.series, a),
                ...
                J(a, function(b, a) {
                    b instanceof u && !b.survive && (g = e && "group" === a ? "hide" : "destroy",
                    b[g]())
                });
            ...
            a.prototype.applyZones = function() {
                var b = this, a = this.chart, c = a.renderer, d = this.zones, e = this.clips || [], h = this.graph, g = this.area, f = Math.max(a.chartWidth, a.chartHeight), l = this[(this.zoneAxis || "y") + "Axis"], k = a.inverted, p, n, q, r, t, y, v, z, x = !1;
            ...
            a.prototype.invertGroups = function(b) {
                ...
                var c = this
                  , d = c.chart;
                c.xAxis && (c.eventsToUnbind.push(y(d, "resize", a)),
                a(),
                c.invertGroups = a)
            }
            ;
            ...
            a.prototype.searchKDTree = function(b, a, c) {
                function d(b, a, c, k) {
                    ...
                    a[r] && (r = d(b, a[r], c + 1, k),
                    n = r[f] < n[f] ? r : m);
                    a[q] && Math.sqrt(p * p) < n[f] && (b = d(b, a[q], c + 1, k),
                    n = b[f] < n[f] ? b : n);
                    return n
                }
                var e = this
            ...
            a.prototype.drawTracker = function() {
                ...
                k ? k.attr({
                    ...
                    zIndex: 2
                }).addClass(c ? "highcharts-tracker-area" : "highcharts-tracker-line").add(b.group),
                e.styledMode || b.tracker.attr({
            ...
            a.prototype.update = function(b, a) {
                ...
                var c = this, d = c.chart, e = c.userOptions, g = c.initialType || c.type, f = d.options.plotOptions, l = F[g].prototype, k = c.finishedAnimating && {
                    animation: !1
                }, m = {}, p, n = ["eventOptions", "navigatorSeries", "baseSeries"], q = b.type || e.type || d.options.chart.type, r = !(this.hasDerivedData || q && q !== this.type || "undefined" !== typeof b.pointStart || "undefined" !== typeof b.pointInterval || "undefined" !== typeof b.relativeXValue || b.joinBy || b.mapData || c.hasOptionChanged("dataGrouping") || c.hasOptionChanged("pointStart") || c.hasOptionChanged("pointInterval") || c.hasOptionChanged("pointIntervalUnit") || c.hasOptionChanged("keys"));
                q = q || g;
                r && (n.push("data", "isDirtyData", "points", "processedData", "processedXData", "processedYData", "xIncrement", "cropped", "_hasPointMarkers", "_hasPointLabels", "clips", "nodes", "layout", "level", "mapMap", "mapData", "minY", "maxY", "minX", "maxX"),
                !1 !== b.visible && n.push("area", "graph"),
                c.parallelArrays.forEach(function(b) {
                    n.push(b + "Data")
                }),
                b.data && (b.dataSorting && v(c.options.dataSorting, b.dataSorting),
                ...
                if (r && this.points) {
                    var t = c.options;
                    !1 === t.visible ? (m.graphic = 1,
                    m.dataLabel = 1) : c._hasPointLabels || (b = t.marker,
                    l = t.dataLabels,
            ...
            a.prototype.setState = function(b, a) {
                ...
                if (c.state !== b && ([c.group, c.markerGroup, c.dataLabelsGroup].forEach(function(a) {
                    a && (c.state && a.removeClass("highcharts-series-" + c.state),
                ...
                !c.chart.styledMode)) {
                    if (g[b] && !1 === g[b].enabled)
                        return;
                    b && (l = g[b].lineWidth || l + (g[b].lineWidthPlus || 0),
                    m = L(g[b].opacity, m));
                    if (e && !e.dashstyle)
                        for (d = {
                            "stroke-width": l
    ...
    K(f, "Extensions/ScrollablePlotArea.js", [f["Core/Animation/AnimationUtilities.js"], f["Core/Axis/Axis.js"], f["Core/Chart/Chart.js"], f["Core/Series/Series.js"], f["Core/Renderer/RendererRegistry.js"], f["Core/Utilities.js"]], function(a, f, B, H, w, E) {
        ...
        A(B, "afterSetChartSize", function(a) {
            ...
            if (!this.renderer.forExport) {
                if (e) {
                    ...
                    c && (this.scrollablePixelsY = e = Math.max(0, c - this.chartHeight)) && (this.scrollablePlotBox = this.renderer.scrollablePlotBox = n(this.plotBox),
        ...
        B.prototype.applyFixed = function() {
            ...
            A(this, "afterLayOutTitles", this.moveFixedElements)) : this.fixedRenderer.setSize(this.chartWidth, this.chartHeight);
    ...
    K(f, "Core/Axis/StackingAxis.js", [f["Core/Animation/AnimationUtilities.js"], f["Core/Axis/Axis.js"], f["Core/Utilities.js"]], function(a, f, B) {
        var C = a.getDeferredAnimation, w = B.addEvent, E = B.destroyObjectProperties, I = B.fireEvent, A = B.isNumber, u = B.objectEach, n;
        (function(a) {
            function e() {
                var a = this.stacking;
                if (a) {
            ...
            var g = function() {
                ...
                a.prototype.buildStacks = function() {
                    var a = this.axis, c = a.series, e = a.options.reversedStacks, g = c.length, f;
                    if (!a.isXAxis) {
    ...
    K(f, "Extensions/Stacking.js", [f["Core/Axis/Axis.js"], f["Core/Chart/Chart.js"], f["Core/FormatUtilities.js"], f["Core/Globals.js"], f["Core/Series/Series.js"], f["Core/Axis/StackingAxis.js"], f["Core/Utilities.js"]], function(a, f, B, H, w, E, I) {
        var A = B.format
          ...
          , t = function() {
            ...
            a.prototype.render = function(a) {
                ...
                c.styledMode || (f.fill = e.backgroundColor,
            ...
            a.prototype.setOffset = function(a, e, f, k, m) {
                ...
                e && h && (m = e.getBBox(),
                k = e.padding,
                l = "left" === l ? b.inverted ? -k : k : "right" === l ? m.width : b.inverted && "center" === l ? m.width / 2 : b.inverted ? f ? m.width + k : -k : m.width / 2,
                f = b.inverted ? m.height / 2 : f ? -k : m.height,
                this.alignOptions.x = g(this.options.x, 0),
                this.alignOptions.y = g(this.options.y, 0),
                h.x -= l,
                h.y -= f,
                e.align(this.alignOptions, null, h),
                b.isInsidePlot(e.alignAttr.x + l - this.alignOptions.x, e.alignAttr.y + f - this.alignOptions.y) ? e.show() : (e.hide(),
                a = !1),
                a && w.prototype.justifyDataLabel.call(this.axis, e, this.alignOptions, e.alignAttr, m, h),
                e.attr({
                    x: e.alignAttr.x,
                    y: e.alignAttr.y
                }),
        ...
        w.prototype.setStackedPoints = function(a) {
            ...
            if (c && (!0 === this.visible || !1 === this.chart.options.chart.ignoreHiddenSeries)) {
                ...
                var d = "-" + a, q = this.negStacks, v = this.yAxis, r = v.stacking.stacks, w = v.stacking.oldStacks, A, C;
                ...
                for (C = 0; C < m; C++) {
                    ...
                    r[E] || (r[E] = {});
                    r[E][B] || (w[E] && w[E][B] ? (r[E][B] = w[E][B],
                    r[E][B].total = null) : r[E][B] = new t(v,v.options.stackLabels,A,B,h));
                    E = r[E][B];
                    null !== H ? (E.points[J] = E.points[this.index] = [g(E.cumulative, l)],
                    n(E.cumulative) || (E.base = J),
                    E.touched = v.stacking.stacksTouched,
                    0 < I.index && !1 === this.singleStacks && (E.points[J][0] = E.points[this.index + "," + B + ",0"][0])) : E.points[J] = E.points[this.index] = null;
                    "percent" === c ? (A = A ? a : d,
                    q && r[A] && r[A][B] ? (A = r[A][B],
                    E.total = A.total = Math.max(A.total, E.total) + Math.abs(H) || 0) : E.total = u(E.total + (Math.abs(H) || 0))) : "group" === c ? (e(H) && (H = H[0]),
                    null !== H && (E.total = (E.total || 0) + 1)) : E.total = u(E.total + (H || 0));
                    E.cumulative = "group" === c ? (E.total || 1) - 1 : g(E.cumulative, l) + (H || 0);
                    null !== H && (E.points[J].push(E.cumulative),
                    p[C] = E.cumulative,
                    E.hasValidPoints = !0)
                }
        ...
        w.prototype.modifyStacks = function() {
            var a = this, c = a.stackKey, e = a.yAxis.stacking.stacks, g = a.processedXData, f, k = a.options.stacking;
    ...
    K(f, "Series/Line/LineSeries.js", [f["Core/Series/Series.js"], f["Core/Series/SeriesRegistry.js"], f["Core/Utilities.js"]], function(a, f, B) {
        var C = this && this.__extends || function() {
            ...
            return function(f, u) {
                ...
                a(f, u);
                f.prototype = null === u ? Object.create(u) : (n.prototype = u.prototype,
                new n)
            }
        }()
          , w = B.defined
        ...
        B = function(f) {
            ...
            A.prototype.drawGraph = function() {
                ...
                c.forEach(function(c, g) {
                    var p = c[0]
                      , n = a[p]
                      , u = n ? "animate" : "attr";
                    n ? (n.endX = a.preventGraphAnimation ? null : k.xMap,
                    n.animate({
                        d: k
                    ...
                    c[3] ? p.dashstyle = c[3] : "square" !== f.linecap && (p["stroke-linecap"] = p["stroke-linejoin"] = "round"),
            ...
            A.prototype.getGraphPath = function(a, f, k) {
                var e = this, c = e.options, p = [], g = [], n, q = c.step;
                a = a || e.points;
                var u = a.reversed;
                u && a.reverse();
                (q = {
                ...
                a.forEach(function(t, x) {
                    ...
                    t.isNull && !w(f) && 0 < x ? n = !c.connectNulls : t.isNull && !f ? n = !0 : (0 === x || n ? x = [["M", t.plotX, t.plotY]] : e.getPointSpline ? x = [e.getPointSpline(a, t, x)] : q ? (x = 1 === q ? [["L", h.plotX, m]] : 2 === q ? [["L", (h.plotX + z) / 2, h.plotY], ["L", (h.plotX + z) / 2, m]] : [["L", z, h.plotY]],
                    x.push(["L", z, m])) : x = [["L", z, m]],
                    g.push(t.x),
                    q && (g.push(t.x),
                    2 === q && g.push(t.x)),
                    p.push.apply(p, x),
    ...
    K(f, "Series/Area/AreaSeries.js", [f["Core/Color/Color.js"], f["Core/Legend/LegendSymbol.js"], f["Core/Series/SeriesRegistry.js"], f["Core/Utilities.js"]], function(a, f, B, H) {
        var w = this && this.__extends || function() {
            ...
            return function(e, c) {
                ...
                a(e, c);
                e.prototype = null === c ? Object.create(c) : (f.prototype = c.prototype,
                new f)
            }
        }()
          , C = a.parse
        ...
        H = function(a) {
            ...
            e.prototype.drawGraph = function() {
                ...
                k.forEach(function(a) {
                    var g = a[0]
                      ...
                      , p = k ? "animate" : "attr"
                      , q = {};
                    k ? (k.endX = c.preventGraphAnimation ? null : e.xMap,
                    k.animate({
                        d: e
                    })) : (q.zIndex = 0,
            ...
            e.prototype.getGraphPath = function(a) {
                var c = I.prototype.getGraphPath, e = this.options, f = e.stacking, k = this.yAxis, u, y = [], x = [], z = this.index, m = k.stacking.stacks[this.stackKey], h = e.threshold, b = Math.round(k.getThreshold(e.threshold));
        ...
        f = function(a) {
            ...
            f.prototype.getPointSpline = function(a, f, k) {
                ...
                if (p && !p.isNull && !1 !== p.doCurve && !f.isCliff && k && !k.isNull && !1 !== k.doCurve && !f.isCliff) {
                    ...
                    u += n;
                    y += n;
                    u > a && u > c ? (u = Math.max(a, c),
                    y = 2 * c - u) : u < a && u < c && (u = Math.min(a, c),
                    y = 2 * c - u);
                    y > k && y > c ? (y = Math.max(k, c),
                    u = 2 * c - y) : y < k && y < c && (y = Math.min(k, c),
                    u = 2 * c - y);
                    f.rightContX = g;
                    f.rightContY = y
                }
    ...
    K(f, "Series/AreaSpline/AreaSplineSeries.js", [f["Series/Area/AreaSeries.js"], f["Series/Spline/SplineSeries.js"], f["Core/Legend/LegendSymbol.js"], f["Core/Series/SeriesRegistry.js"], f["Core/Utilities.js"]], function(a, f, B, H, w) {
        var C = this && this.__extends || function() {
            ...
            return function(f, e) {
                ...
                a(f, e);
                f.prototype = null === e ? Object.create(e) : (c.prototype = e.prototype,
                new c)
            }
        }()
          , I = a.prototype
    ...
    K(f, "Series/Column/ColumnSeries.js", [f["Core/Animation/AnimationUtilities.js"], f["Core/Color/Color.js"], f["Core/Globals.js"], f["Core/Legend/LegendSymbol.js"], f["Core/Series/Series.js"], f["Core/Series/SeriesRegistry.js"], f["Core/Utilities.js"]], function(a, f, B, H, w, E, I) {
        var C = this && this.__extends || function() {
            ...
            return function(c, b) {
                ...
                a(c, b);
                c.prototype = null === b ? Object.create(b) : (e.prototype = b.prototype,
                new e)
            }
        }()
          , u = a.animObject
        ...
        I = function(a) {
            ...
            f.prototype.animate = function(b) {
                ...
                if (b)
                    ...
                    h ? k.translateX = b - c.len : k.translateY = b,
                    a.clipBox && a.setClip(),
                    a.group.attr(k);
                else {
            ...
            f.prototype.crispCol = function(b, a, c, e) {
                ...
                this.options.crisp && (c = Math.round(b + c) + h,
                b = Math.round(b) + h,
                c -= b);
                e = Math.round(a + e) + f;
                h = .5 >= Math.abs(a) && .5 < e;
                    ...
                    z(this.yAxis.stacking && this.yAxis.stacking.stacks, function(b) {
                        if ("number" === typeof c.x && (b = b[c.x.toString()])) {
                            var a = b.points[d.index]
                              , e = b.total;
                            f ? (a && (g = l),
                            b.hasValidPoints && (h ? l++ : l--)) : q(a) && (g = a[1],
                            l = e || 0)
                        }
                    });
            ...
            f.prototype.translate = function() {
                ...
                b.points.forEach(function(d) {
                    ...
                    v = Math.abs(v - m) > n ? f - n : m - (r ? n : 0));
                    p(d.options.pointWidth) && (D = B = Math.ceil(d.options.pointWidth),
                    A -= Math.round((D - t) / 2));
            ...
            f.prototype.pointAttribs = function(b, a) {
                ...
                a && b && (b = y(c.states[a], b.options.states && b.options.states[a] || {}),
                a = b.brightness,
            ...
            f.prototype.drawPoints = function() {
                var b = this, a = this.chart, c = b.options, e = a.renderer, f = c.animationLimit || 250, h;
                b.points.forEach(function(d) {
                    var g = d.graphic
                      , l = !!g
            ...
            f.prototype.drawTracker = function() {
                var b = this, a = b.chart, d = a.pointer, e = function(b) {
                    var a = d.getPointFromEvent(b);
                    "undefined" !== typeof a && (d.isDirectTouch = !0,
                    a.onMouseOver(b))
                }, f;
    ...
    K(f, "Core/Series/DataLabel.js", [f["Core/Animation/AnimationUtilities.js"], f["Core/FormatUtilities.js"], f["Core/Utilities.js"]], function(a, f, B) {
        var C = a.getDeferredAnimation, w = f.format, E = B.defined, I = B.extend, A = B.fireEvent, u = B.isArray, n = B.merge, k = B.objectEach, e = B.pick, c = B.splat, p;
        (function(a) {
            function f(a, b, c, d, f) {
                ...
                if (x && E(m) && E(p)) {
                    ...
                    y = [q.x - Number(b.attr("x")), q.y - Number(b.attr("y"))],
                    z(m),
                    b[f ? "attr" : "animate"](m)) : (z(d),
                    b.align(c, void 0, d),
                    m = b.alignAttr);
                    u && 0 <= d.height ? this.justifyDataLabel(b, c, m, q, d, f) : e(c.crop, !0) && (d = m.x,
                    z = m.y,
                    d += y[0],
                    z += y[1],
            ...
            function p() {
                var a = this, b = a.chart, f = a.options, d = a.points, m = a.hasRendered || 0, p = b.renderer, n = f.dataLabels, q, t = n.animation;
                t = n.defer ? C(b, t, a) : {
                    defer: 0,
                    duration: 0
                };
                ...
                if (u(n) || n.enabled || a._hasPointLabels) {
                    ...
                    !m && (m = a.dataLabelsGroup) && (a.visible && z.show(),
                    m[f.animation ? "animate" : "attr"]({
                        opacity: 1
                    }, t));
                    d.forEach(function(d) {
                        ...
                        q.forEach(function(c, h) {
                            ...
                            if (l) {
                                ...
                                v = c.style;
                                var u = c.rotation;
                                b.styledMode || (v.color = e(c.color, v.color, a.color, "#000000"),
                                "contrast" === v.color ? (d.contrastColor = p.getContrast(d.color || a.color),
                                v.color = !E(r) && c.inside || 0 > r || f.stacking ? d.contrastColor : "#000000") : delete d.contrastColor,
                                ...
                                b.styledMode || (x.fill = c.backgroundColor,
                            ...
                            !n || l && E(t) && !!n.div === !!c.useHTML && (n.rotation && c.rotation || n.rotation === c.rotation) || (q = !0,
                            d.dataLabel = n = d.dataLabel && d.dataLabel.destroy(),
                            d.dataLabels && (1 === d.dataLabels.length ? delete d.dataLabels : delete d.dataLabels[h]),
                            h || delete d.dataLabel,
                            m && (d.connector = d.connector.destroy(),
                            d.connectors && (1 === d.connectors.length ? delete d.connectors : delete d.connectors[h])));
                            l && E(t) ? (n ? x.text = t : (d.dataLabels = d.dataLabels || [],
                            n = d.dataLabels[h] = u ? p.text(t, 0, 0, c.useHTML).addClass("highcharts-data-label") : p.label(t, 0, 0, c.shape, null, null, c.useHTML, null, "data-label"),
                            h || (d.dataLabel = n),
                            n.addClass(" highcharts-data-label-color-" + d.colorIndex + " " + (c.className || "") + (c.useHTML ? " highcharts-tracker" : ""))),
                            n.options = c,
                            n.attr(x),
                            b.styledMode || n.css(v).shadow(c.shadow),
                            n.added || n.add(z),
                            c.textPath && !c.useHTML && (n.setTextPath(d.getDataLabelPath && d.getDataLabelPath(n) || d.graphic, c.textPath),
            ...
            function y(a, b, c, d, e, f) {
                ...
                var n = (c.x || 0) + l;
                if (0 > n) {
                    "right" === g && 0 <= m ? (b.align = "left",
                    b.inside = !0) : m -= n;
                    var q = !0
                }
                n = (c.x || 0) + d.width - l;
                n > h.plotWidth && ("left" === g && 0 >= m ? (b.align = "right",
                b.inside = !0) : m += h.plotWidth - n,
                q = !0);
                n = c.y + l;
                0 > n && ("bottom" === k && 0 <= p ? (b.verticalAlign = "top",
                b.inside = !0) : p -= n,
                q = !0);
                n = (c.y || 0) + d.height - l;
                n > h.plotHeight && ("top" === k && 0 >= p ? (b.verticalAlign = "bottom",
                b.inside = !0) : p += h.plotHeight - n,
                q = !0);
                q && (b.x = m,
                b.y = p,
                a.placed = !f,
    ...
    K(f, "Series/Column/ColumnDataLabel.js", [f["Core/Series/DataLabel.js"], f["Core/Series/SeriesRegistry.js"], f["Core/Utilities.js"]], function(a, f, B) {
        var C = f.series, w = B.merge, E = B.pick, I;
        (function(f) {
    ...
    K(f, "Series/Scatter/ScatterSeries.js", [f["Series/Column/ColumnSeries.js"], f["Series/Line/LineSeries.js"], f["Core/Series/SeriesRegistry.js"], f["Core/Utilities.js"]], function(a, f, B, H) {
        var w = this && this.__extends || function() {
            ...
            return function(f, k) {
                ...
                a(f, k);
                f.prototype = null === k ? Object.create(k) : (e.prototype = k.prototype,
                new e)
            }
        }()
          , C = H.addEvent
        ...
        H = function(a) {
            ...
            n.defaultOptions = A(f.defaultOptions, {
                ...
                tooltip: {
                    headerFormat: '<span style="color:{point.color}">\u25cf</span> <span style="font-size: 0.625em"> {series.name}</span><br/>',
    ...
    K(f, "Series/CenteredUtilities.js", [f["Core/Globals.js"], f["Core/Series/Series.js"], f["Core/Utilities.js"]], function(a, f, B) {
        var C = a.deg2rad, w = B.isNumber, E = B.pick, I = B.relativeLength, A;
        (function(a) {
        ...
        a(f.prototype, {
            connectorShapes: {
                ...
                crookedLine: function(a, e, c) {
                    ...
                    c = ["L", k, a.y];
                    g = !0;
                    if ("left" === f ? k > a.x || k < e.x : k < a.x || k > e.x)
                        g = !1;
                    a = [["M", a.x, a.y]];
                    g && a.push(c);
                    a.push(["L", e.x, e.y]);
    ...
    K(f, "Series/Pie/PieSeries.js", [f["Series/CenteredUtilities.js"], f["Series/Column/ColumnSeries.js"], f["Core/Globals.js"], f["Core/Legend/LegendSymbol.js"], f["Series/Pie/PiePoint.js"], f["Core/Series/Series.js"], f["Core/Series/SeriesRegistry.js"], f["Core/Renderer/SVG/Symbols.js"], f["Core/Utilities.js"]], function(a, f, B, H, w, E, I, A, u) {
        var n = this && this.__extends || function() {
            ...
            return function(c, e) {
                ...
                a(c, e);
                c.prototype = null === e ? Object.create(e) : (f.prototype = e.prototype,
                new f)
            }
        }()
        ...
        u = function(a) {
            ...
            c.prototype.redrawPoints = function() {
                var a = this, c = a.chart, e = c.renderer, f = a.options.shadow, b, l, d, k;
                this.drawEmpty();
                ...
                a.points.forEach(function(h) {
                    ...
                    if (!h.isNull && l) {
                        ...
                        c.styledMode || l.attr(d).attr({
                            "stroke-linejoin": "round"
                        }).shadow(f, n),
                        h.delayedRendering = !1) : (l.setRadialReference(a.center),
    ...
    K(f, "Series/Pie/PieDataLabel.js", [f["Core/Series/DataLabel.js"], f["Core/Globals.js"], f["Core/Renderer/RendererUtilities.js"], f["Core/Series/SeriesRegistry.js"], f["Core/Utilities.js"]], function(a, f, B, H, w) {
        var C = f.noop, I = B.distribute, A = H.series, u = w.arrayMax, n = w.clamp, k = w.defined, e = w.merge, c = w.pick, p = w.relativeLength, g;
        (function(f) {
            function g() {
                var a = this, f = a.data, b = a.chart, g = a.options.dataLabels || {}, d = g.connectorPadding, n = b.plotWidth, p = b.plotHeight, q = b.plotLeft, t = Math.round(b.chartWidth / 3), w = a.center, z = w[2] / 2, x = w[1], y = [[], []], C = [0, 0, 0, 0], B = a.dataLabelPositioners, F, E, H, K, U, G, T, M, V, W, Z, R;
                    ...
                    if (h) {
                        ...
                        if (0 < a.maxLabelDistance) {
                            ...
                            e.forEach(function(a) {
                                0 < a.labelDistance && a.dataLabel && (a.top = Math.max(0, x - z - a.labelDistance),
                                a.bottom = Math.min(x + z + a.labelDistance, b.plotHeight),
                        ...
                        for (Z = 0; Z < h; Z++) {
                            ...
                            V = r = G.natural.y;
                            l && k(F.distributeBox) && ("undefined" === typeof F.distributeBox.pos ? W = "hidden" : (T = F.distributeBox.size,
                            V = B.radialDistributionY(F)));
                            ...
                            G.final.x = M;
                            G.final.y = V;
                            c(g.crop, !0) && (U = K.getBBox().width,
                            r = null,
                            M - U < d && 1 === f ? (r = Math.round(U - M + d),
                            C[3] = Math.max(r, C[3])) : M + U > n - d && 0 === f && (r = Math.round(M + U - n + d),
                            C[1] = Math.max(r, C[1])),
                            0 > V - T / 2 ? C[0] = Math.max(Math.round(-V + T / 2), C[0]) : V + T / 2 > p && (C[2] = Math.max(Math.round(V + T / 2 - p), C[2])),
                            K.sideOverflow = r)
                        }
                    }
                }),
                0 === u(C) || this.verifyDataLabelOverflow(C)) && (this.placeDataLabels(),
                this.points.forEach(function(d) {
                    ...
                    if (E = c(R.connectorWidth, 1)) {
                        ...
                        if ((K = d.dataLabel) && K._pos && d.visible && 0 < d.labelDistance) {
                            ...
                            if (f = !H)
                                d.connector = H = b.renderer.path().addClass("highcharts-data-label-connector  highcharts-color-" + d.colorIndex + (d.className ? " " + d.className : "")).add(a.dataLabelsGroup),
                                b.styledMode || H.attr({
                                    "stroke-width": E,
            ...
            function t() {
                this.points.forEach(function(a) {
                    var c = a.dataLabel, b;
                    c && a.visible && ((b = c._pos) ? (c.sideOverflow && (c._attr.width = Math.max(c.getBBox().width - c.sideOverflow, 0),
                    c.css({
            ...
            function w(a) {
                ...
                if (!f) {
                    if (null !== e[0])
                        ...
                        c[0] += (a[3] - a[1]) / 2;
                    null !== e[1] ? g = n(g, d, c[2] - Math.max(a[0], a[2])) : (g = n(g, d, c[2] - a[0] - a[2]),
                    c[1] += (a[0] - a[2]) / 2);
                    g < c[2] ? (c[2] = g,
                    c[3] = Math.min(b.thickness ? Math.max(0, g - 2 * b.thickness) : Math.max(0, p(b.innerSize || 0, g)), g),
                    this.translate(c),
    ...
    K(f, "Extensions/OverlappingDataLabels.js", [f["Core/Chart/Chart.js"], f["Core/Utilities.js"]], function(a, f) {
        function C(a, f) {
            ...
            if (a) {
                var c = a.newOpacity;
                a.oldOpacity !== c && (a.alignAttr && a.placed ? (a[c ? "removeClass" : "addClass"]("highcharts-data-label-hidden"),
                e = !0,
                ...
                e.visible && (!1 !== c.enabled || e._hasPointLabels) && (c = function(c) {
                    return c.forEach(function(c) {
                        c.visible && (E(c.dataLabels) ? c.dataLabels : c.dataLabel ? [c.dataLabel] : []).forEach(function(e) {
                            ...
                            g.allowOverlap ? (e.oldOpacity = e.opacity,
                            e.newOpacity = 1,
                            C(e, a)) : f.push(e)
                        })
                    })
        ...
        a.prototype.hideOverlappingLabels = function(a) {
            var f = this, e = a.length, c = f.renderer, n, g, t, q = !1;
            var u = function(a) {
    ...
    K(f, "Core/Responsive.js", [f["Core/Utilities.js"]], function(a) {
        var f = a.extend, B = a.find, H = a.isArray, w = a.isObject, E = a.merge, I = a.objectEach, A = a.pick, u = a.splat, n = a.uniqueKey, k;
        (function(a) {
            var c = [];
            a.compose = function(a) {
                -1 === c.indexOf(a) && (c.push(a),
                f(a.prototype, e.prototype));
                return a
            }
            ;
            var e = function() {
                    ...
                    function c(a, f, g, h) {
                        ...
                        I(a, function(a, d) {
                            if (!h && -1 < e.collectionsWithUpdate.indexOf(d) && f[d])
                                for (a = u(a),
                                g[d] = [],
                                b = 0; b < Math.max(a.length, f[d].length); b++)
                                    f[d][b] && (void 0 === a[b] ? g[d][b] = f[d][b] : (g[d][b] = {},
                                    c(a[b], f[d][b], g[d][b], h + 1)));
                            else
                                w(a) ? (g[d] = H(a) ? [] : {},
                                c(a, f[d] || {}, g[d], h + 1)) : g[d] = "undefined" === typeof f[d] ? null : f[d]
                        })
                    }
                    var e = this
                      , f = {};
                ...
                a.prototype.setResponsive = function(a, c) {
                    ...
                    k = k.toString() || void 0;
                    k !== (g && g.ruleIds) && (g && this.update(g.undoOptions, a, !0),
                    k ? (g = this.currentOptions(c),
